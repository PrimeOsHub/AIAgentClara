...
declare const RawRefreshSchema: z.ZodObject<{
    tokenEndpoint: z.ZodOptional<z.ZodString>;
    token_endpoint: z.ZodOptional<z.ZodString>;
    clientIdEnv: z.ZodOptional<z.ZodString>;
    client_id_env: z.ZodOptional<z.ZodString>;
    clientSecretEnv: z.ZodOptional<z.ZodString>;
    client_secret_env: z.ZodOptional<z.ZodString>;
    clientAuthMethod: z.ZodOptional<z.ZodString>;
    client_auth_method: z.ZodOptional<z.ZodString>;
    refreshSkewSeconds: z.ZodOptional<z.ZodNumber>;
    refresh_skew_seconds: z.ZodOptional<z.ZodNumber>;
    accessTokenEnv: z.ZodOptional<z.ZodString>;
    access_token_env: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
export declare const RawEntrySchema: z.ZodObject<{
    ...
    oauthClientSecretEnv: z.ZodOptional<z.ZodString>;
    oauth_client_secret_env: z.ZodOptional<z.ZodString>;
    oauthTokenEndpointAuthMethod: z.ZodOptional<z.ZodString>;
    oauth_token_endpoint_auth_method: z.ZodOptional<z.ZodString>;
    ...
    httpFetch: z.ZodOptional<z.ZodEnum<{
        default: "default";
        "node-http1": "node-http1";
    }>>;
    http_fetch: z.ZodOptional<z.ZodEnum<{
        default: "default";
        "node-http1": "node-http1";
    }>>;
    ...
    blocked_tools: z.ZodOptional<z.ZodArray<z.ZodString>>;
}, z.core.$strip>;
export declare const RawConfigSchema: z.ZodObject<{
    ...
    daemonIdleTimeoutMs: z.ZodOptional<z.ZodNumber>;
    daemon_idle_timeout_ms: z.ZodOptional<z.ZodNumber>;

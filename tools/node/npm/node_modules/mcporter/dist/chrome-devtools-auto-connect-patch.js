...
export function patchChromeDevtoolsMcp(mainPath = process.argv[1]) {
    ...
    const withHelper = source.replace('const NAVIGATION_TIMEOUT = 10_000;\n', `const NAVIGATION_TIMEOUT = 10_000;\n${HELPER}`);
...
//# sourceMappingURL=chrome-devtools-auto-connect-patch.js.map
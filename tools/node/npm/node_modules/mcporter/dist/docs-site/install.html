...
<head>
  ...
  <title>Install — mcporter</title>
  <meta name="description" content="Install — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/install.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Install — mcporter">
  <meta property="og:description" content="Install — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/install.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Install — mcporter">
  <meta name="twitter:description" content="Install — mcporter documentation.">
    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/install.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="install">Install</h1>
<p>mcporter ships as both a published npm package and a Homebrew formula. Most workflows can also run mcporter without installing anything via <code>npx</code>.</p>
<h2 id="try-without-installing"><a class="anchor" href="#try-without-installing" aria-label="Anchor link">#</a>Try without installing</h2>
<pre><code class="language-bash">npx mcporter --version
npx mcporter list</code></pre>
<p><code>npx</code> keeps the package in your npm cache, so subsequent runs are instant. This is the recommended first step.</p>
<h2 id="npm-pnpm-bun"><a class="anchor" href="#npm-pnpm-bun" aria-label="Anchor link">#</a>npm / pnpm / Bun</h2>
<p>Install globally:</p>
<pre><code class="language-bash">npm install -g mcporter</code></pre>
<p>Or add it to a project:</p>
<pre><code class="language-bash">pnpm add mcporter        # or: npm install mcporter / bun add mcporter</code></pre>
<p>mcporter targets Node 24+ and works under Bun. The package exposes both an importable runtime (<code>createRuntime</code>, <code>callOnce</code>, <code>createServerProxy</code>) and the <code>mcporter</code> CLI binary.</p>
<h2 id="homebrew"><a class="anchor" href="#homebrew" aria-label="Anchor link">#</a>Homebrew</h2>
<pre><code class="language-bash">brew install steipete/tap/mcporter</code></pre>
<p>The tap publishes alongside npm. If you previously installed from an older tap, run <code>brew update</code> before reinstalling so Homebrew picks up the new formula path.</p>
<h2 id="standalone-binary"><a class="anchor" href="#standalone-binary" aria-label="Anchor link">#</a>Standalone binary</h2>
<p>Each release also ships a Bun-compiled standalone binary you can drop on <code>$PATH</code> without a Node toolchain. Grab the asset for your OS/arch from the <a href="https://github.com/steipete/mcporter/releases">GitHub releases page</a> and <code>chmod +x</code> it. The compiled CLI behaves the same as the Node build but boots noticeably faster and bundles its dependencies.</p>
<h2 id="verify"><a class="anchor" href="#verify" aria-label="Anchor link">#</a>Verify</h2>
<pre><code class="language-bash">mcporter --version
mcporter list</code></pre>
<p>The first invocation will print every MCP server it discovered across your configs (Cursor, Claude Code/Desktop, Codex, Windsurf, OpenCode, VS Code). If nothing shows up, jump to <a href="config.html">Configuration</a> to add a server.</p>
<h2 id="updating"><a class="anchor" href="#updating" aria-label="Anchor link">#</a>Updating</h2>
<ul>
<li><code>npm</code>: <code>npm install -g mcporter@latest</code></li>
<li><code>pnpm</code>: <code>pnpm up -g mcporter@latest</code></li>
<li><code>brew</code>: <code>brew upgrade steipete/tap/mcporter</code></li>
<li>Standalone binary: download a fresh release asset.</li>
</ul>
<h2 id="uninstall"><a class="anchor" href="#uninstall" aria-label="Anchor link">#</a>Uninstall</h2>
<ul>
<li><code>npm uninstall -g mcporter</code></li>
<li><code>brew uninstall steipete/tap/mcporter</code></li>
<li>Standalone binary: delete the file you copied onto <code>$PATH</code>.</li>
</ul>
<p>mcporter stores OAuth tokens and cached schemas under <code>~/.mcporter/</code> (or <code>$XDG_CACHE_HOME/mcporter/</code> when set). Remove that directory if you want a fully clean slate.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="./"><small>Previous</small><span>Overview</span></a><a class="page-nav-next" href="quickstart.html"><small>Next</small><span>Quickstart</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#try-without-installing">Try without installing</a><a class="toc-l2" href="#npm-pnpm-bun">npm / pnpm / Bun</a><a class="toc-l2" href="#homebrew">Homebrew</a><a class="toc-l2" href="#standalone-binary">Standalone binary</a><a class="toc-l2" href="#verify">Verify</a><a class="toc-l2" href="#updating">Updating</a><a class="toc-l2" href="#uninstall">Uninstall</a></nav>
      </div>
    </main>
  </div>
  <script>

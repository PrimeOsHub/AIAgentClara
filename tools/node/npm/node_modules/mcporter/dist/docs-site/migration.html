...
<head>
  ...
  <title>Migration Guide — mcporter</title>
  <meta name="description" content="Migration Guide — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/migration.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Migration Guide — mcporter">
  <meta property="og:description" content="Migration Guide — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/migration.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Migration Guide — mcporter">
  <meta name="twitter:description" content="Migration Guide — mcporter documentation.">
    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/migration.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="migration-guide">Migration Guide</h1>
<p>This guide walks through replacing the Python-based <code>pnpm mcp:*</code> helpers with the new TypeScript runtime and CLI.</p>
<h2 id="1-install"><a class="anchor" href="#1-install" aria-label="Anchor link">#</a>1. Install</h2>
<pre><code class="language-bash">pnpm add mcporter
# or
yarn add mcporter
# or
npm install mcporter</code></pre>
<h2 id="2-update-scripts"><a class="anchor" href="#2-update-scripts" aria-label="Anchor link">#</a>2. Update Scripts</h2>
<ul>
<li>Replace <code>pnpm mcporter:list</code> with <code>npx mcporter list</code>.</li>
<li>Replace <code>pnpm mcporter:call &lt;server&gt;.&lt;tool&gt; key=value</code> with <code>npx mcporter call &lt;server&gt;.&lt;tool&gt; key=value</code>.</li>
<li>Add <code>--config &lt;path&gt;</code> if your configuration is not under <code>./config/mcporter.json</code>.</li>
<li>Optional: set <code>&quot;imports&quot;</code> inside <code>mcporter.json</code> (for example <code>[]</code> to disable auto-imports or <code>[&quot;cursor&quot;, &quot;codex&quot;]</code> to customize the order).</li>
<li>Append <code>--tail-log</code> to stream the last 20 lines of any log file returned by the tool.</li>
</ul>
<h2 id="3-oauth-tokens"><a class="anchor" href="#3-oauth-tokens" aria-label="Anchor link">#</a>3. OAuth Tokens</h2>
<ul>
<li>Tokens are saved in the shared vault under <code>~/.mcporter/credentials.json</code> by default, or <code>$XDG_DATA_HOME/mcporter/credentials.json</code> when <code>XDG_DATA_HOME</code> is set.</li>
<li>To force a fresh login, delete that directory and rerun the command; the CLI will relaunch the browser.</li>
<li>Custom <code>token_cache_dir</code> entries in <code>mcporter.json</code> continue to work as explicit overrides.</li>
</ul>
<h2 id="4-programmatic-usage"><a class="anchor" href="#4-programmatic-usage" aria-label="Anchor link">#</a>4. Programmatic Usage</h2>
<pre><code class="language-ts">import { createRuntime } from &#39;mcporter&#39;;
...
await runtime.close();</code></pre>
<p>Prefer <code>createRuntime</code> for long-lived agents so connections and OAuth tokens can be reused.</p>
<h2 id="5-single-call-helper"><a class="anchor" href="#5-single-call-helper" aria-label="Anchor link">#</a>5. Single Call Helper</h2>
<pre><code class="language-ts">import { callOnce } from &#39;mcporter&#39;;
...
<p>Use <code>callOnce</code> for fire-and-forget invocations.</p>
<h2 id="6-environment-variables"><a class="anchor" href="#6-environment-variables" aria-label="Anchor link">#</a>6. Environment Variables</h2>
<ul>
<li><code>LINEAR_API_KEY</code>, <code>FIRECRAWL_API_KEY</code>, and similar tokens are read exactly as before via <code>${VAR}</code> syntax.</li>
<li><code>${VAR:-default}</code> continues to work; empty values are ignored.</li>
<li><code>$env:VAR</code> placeholders resolve to raw OS environment variables.</li>
</ul>
<h2 id="7-troubleshooting"><a class="anchor" href="#7-troubleshooting" aria-label="Anchor link">#</a>7. Troubleshooting</h2>
<table><thead><tr><th>Symptom</th><th>Fix</th></tr></thead><tbody><tr><td>Browser did not open</td><td>Copy the printed OAuth URL manually into a browser.</td></tr><tr><td>Authorization hangs</td><td>Ensure the callback URL can bind to <code>127.0.0.1</code>; firewalls may block it.</td></tr><tr><td>Tokens are stale</td><td>Run <code>mcporter auth --reset &lt;server&gt;</code> or delete the matching vault entry/cache and retry.</td></tr><tr><td>Stdio command fails</td><td>Pass <code>--root</code> to point at the repo root so relative paths resolve.</td></tr></tbody></table>
<hr>
<p>For deeper architectural notes and future work, see <a href="spec.html"><code>docs/spec.md</code></a>.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="spec.html"><small>Previous</small><span>mcporter Roadmap</span></a><a class="page-nav-next" href="pnpm-mcp-migration.html"><small>Next</small><span>Migrating from `pnpm mcp:*`</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#1-install">1. Install</a><a class="toc-l2" href="#2-update-scripts">2. Update Scripts</a><a class="toc-l2" href="#3-oauth-tokens">3. OAuth Tokens</a><a class="toc-l2" href="#4-programmatic-usage">4. Programmatic Usage</a><a class="toc-l2" href="#5-single-call-helper">5. Single Call Helper</a><a class="toc-l2" href="#6-environment-variables">6. Environment Variables</a><a class="toc-l2" href="#7-troubleshooting">7. Troubleshooting</a></nav>
      </div>
    </main>
  </div>
  <script>

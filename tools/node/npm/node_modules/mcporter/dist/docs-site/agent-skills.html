...
<head>
  ...
  <title>Agent Skill Pattern — mcporter</title>
  <meta name="description" content="Agent Skill Pattern — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/agent-skills.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Agent Skill Pattern — mcporter">
  <meta property="og:description" content="Agent Skill Pattern — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/agent-skills.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Agent Skill Pattern — mcporter">
  <meta name="twitter:description" content="Agent Skill Pattern — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link active" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Agents</p>
          <h1>Agent Skill Pattern</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/agent-skills.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="agent-skill-pattern">Agent Skill Pattern</h1>
<p>Prefer one small skill per MCP server or workflow instead of a single generic <code>mcporter</code> skill. A focused skill keeps the agent prompt small, names the useful tools directly, and avoids loading schemas for servers that are irrelevant to the current task.</p>
<h2 id="recommended-flow"><a class="anchor" href="#recommended-flow" aria-label="Anchor link">#</a>Recommended Flow</h2>
<ol>
<li>Add or import the MCP server:</li>
</ol>
<p>``<code>bash npx mcporter config add docs https://mcp.context7.com/mcp --scope home </code>``</p>
<ol>
<li>Inspect the tool surface:</li>
</ol>
<p>``<code>bash npx mcporter list docs --brief npx mcporter list docs --schema </code>``</p>
<ol>
<li>Write a skill that calls only the relevant tools via <code>mcporter call</code>:</li>
</ol>
<p>```markdown</p>
<hr>
<p>name: docs-mcp description: Fetch package and framework docs through the configured docs MCP server.</p>
<hr>
<p># Docs MCP</p>
<p>Use <code>npx mcporter call docs.resolve-library-id query=&lt;task&gt; libraryName=&lt;name&gt;</code> to resolve a package, then call <code>npx mcporter call docs.query-docs ...</code> with the resolved ID and docs query. ```</p>
<ol>
<li>For repeated or shareable workflows, generate a dedicated CLI instead of</li>
<p>teaching the agent raw <code>mcporter call</code> syntax:</p>
</ol>
<p>``<code>bash npx mcporter generate-cli docs --bundle dist/docs-mcp.js </code>``</p>
<h2 id="why-not-one-generic-skill"><a class="anchor" href="#why-not-one-generic-skill" aria-label="Anchor link">#</a>Why Not One Generic Skill?</h2>
<p>A generic skill has to teach the agent how to discover, choose, and call every configured server. That recreates the large-schema context problem MCPorter is trying to avoid. Per-server skills stay small and let the skill author describe the safe, useful workflows for that server.</p>
<p>Use <code>allowedTools</code> or <code>blockedTools</code> in <code>mcporter.json</code> when a server exposes tools that should not be shown to agents.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="mcp.html"><small>Previous</small><span>mcporter Overview</span></a><a class="page-nav-next" href="subagent.html"><small>Next</small><span>Claude Subagent Quickstart</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#recommended-flow">Recommended Flow</a><a class="toc-l2" href="#why-not-one-generic-skill">Why Not One Generic Skill?</a></nav>
      </div>
    </main>
  </div>
  <script>

...
<head>
  ...
  <title>Tool Calling Cheatsheet — mcporter</title>
  <meta name="description" content="Tool Calling Cheatsheet — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/tool-calling.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Tool Calling Cheatsheet — mcporter">
  <meta property="og:description" content="Tool Calling Cheatsheet — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/tool-calling.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Tool Calling Cheatsheet — mcporter">
  <meta name="twitter:description" content="Tool Calling Cheatsheet — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link active" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Generators</p>
          <h1>Tool Calling Cheatsheet</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/tool-calling.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="tool-calling-cheatsheet">Tool Calling Cheatsheet</h1>
<p>mcporter accepts multiple argument styles so you can match whatever feels most natural in your shell or script. Every style feeds the same validation pipeline (schema-driven type coercion, required-field checks, enum hints), so pick the one that&#39;s easiest to type.</p>
<h2 id="1-inferred-call-command"><a class="anchor" href="#1-inferred-call-command" aria-label="Anchor link">#</a>1. Inferred Call Command</h2>
<pre><code class="language-bash">mcporter linear.list_issues team=ENG
mcporter context7.resolve-library-id libraryName:value
mcporter firecrawl.scrape &#39;url: &quot;https://example.com&quot;&#39;</code></pre>
<ul>
<li>Dotted tokens (<code>server.tool</code>) automatically run the <code>call</code> command.</li>
<li>Trailing arguments can use <code>key=value</code>, <code>key:value</code>, or <code>key: value</code> formats; multi-word values need normal shell quoting.</li>
<li><code>server=value</code> / <code>tool=value</code> behave like their flag counterparts if you need to override the selector.</li>
</ul>
<h2 id="2-explicit-call-flags"><a class="anchor" href="#2-explicit-call-flags" aria-label="Anchor link">#</a>2. Explicit <code>call</code> + Flags</h2>
<pre><code class="language-bash">mcporter call linear.create_issue --team ENG --title &quot;Bug report&quot;
mcporter call chrome-devtools.take_snapshot output=markdown
mcporter call context7.resolve-library-id libraryName: value</code></pre>
<ul>
<li>Use <code>--flag value</code> when you prefer long-form CLI syntax.</li>
<li>Mixed forms are fine: <code>mcporter call linear.create_issue --team ENG title=value due: tomorrow</code>.</li>
<li><code>--args &#39;{&quot;title&quot;:&quot;Bug&quot;}&#39;</code> still ingests JSON payloads directly.</li>
<li>Unknown long flags now error instead of silently becoming tool arguments; use <code>title=value</code>, <code>--args</code>, or <code>--</code> before literal positional values beginning with <code>--</code>.</li>
</ul>
<h2 id="3-function-call-syntax"><a class="anchor" href="#3-function-call-syntax" aria-label="Anchor link">#</a>3. Function-Call Syntax</h2>
<pre><code class="language-bash">mcporter call &#39;linear.create_issue(title: &quot;Bug&quot;, team: &quot;ENG&quot;)&#39;
mcporter &#39;context7.resolve-library-id(query: &quot;React hooks docs&quot;, libraryName: &quot;react&quot;)&#39;
mcporter &#39;context7.resolve-library-id(&quot;React hooks docs&quot;, &quot;react&quot;)&#39;</code></pre>
<ul>
<li>Mirrors the pseudo-TypeScript signature printed by <code>mcporter list</code>.</li>
<li>You may omit labels and rely on the schema order—<code>mcporter &#39;context7.resolve-library-id(&quot;React hooks docs&quot;, &quot;react&quot;)&#39;</code> maps arguments to the live schema order automatically.</li>
<li>Supports nested objects/arrays and gives detailed parser errors when the expression is malformed.</li>
<li>Wrap the whole expression in quotes so the shell leaves parentheses/commas intact.</li>
</ul>
<h2 id="4-mixed-server-tool-overrides"><a class="anchor" href="#4-mixed-server-tool-overrides" aria-label="Anchor link">#</a>4. Mixed Server/Tool Overrides</h2>
<pre><code class="language-bash">mcporter call --server linear resolve_library_id libraryName=value
mcporter call --tool scrape firecrawl url=https://example.com</code></pre>
<ul>
<li>Pass <code>--server</code> / <code>--tool</code> when you want to reuse cached selectors or the command inference isn’t enough.</li>
<li>Anything after the selector uses the same unified key/value parsing.</li>
</ul>
<h2 id="5-ad-hoc-servers"><a class="anchor" href="#5-ad-hoc-servers" aria-label="Anchor link">#</a>5. Ad-hoc Servers</h2>
<pre><code class="language-bash">mcporter call https://mcp.deepwiki.com/sse.ask_question repoName=value question:&quot;What&#39;s new?&quot;
mcporter call --http-url https://mcp.example.com/mcp fetch_docs repoName=value</code></pre>
<ul>
<li>Bare URLs trigger ad-hoc server registration; you can still use all of the styles above for arguments.</li>
<li>Combine with <code>--stdio &quot;bun run ./server.ts&quot;</code> (plus <code>--stdio-arg</code>, <code>--env</code>, <code>--cwd</code>) for local transports.</li>
</ul>
<hr>
<p><strong>Tips</strong></p>
<ul>
<li>Use <code>mcporter list &lt;server&gt;</code> to see parameter names, return types, and example invocations.</li>
<li>Optional fields hide by default; add <code>--all-parameters</code> when listing a server to reveal everything.</li>
<li><code>mcporter auth &lt;server|url&gt;</code> accepts the same ad-hoc flags, so you can authenticate immediately after a 401 without editing config.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="emit-ts.html"><small>Previous</small><span>`mcporter emit-ts`</span></a><a class="page-nav-next" href="adhoc.html"><small>Next</small><span>Ad-hoc MCP Servers</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#1-inferred-call-command">1. Inferred Call Command</a><a class="toc-l2" href="#2-explicit-call-flags">2. Explicit call + Flags</a><a class="toc-l2" href="#3-function-call-syntax">3. Function-Call Syntax</a><a class="toc-l2" href="#4-mixed-server-tool-overrides">4. Mixed Server/Tool Overrides</a><a class="toc-l2" href="#5-ad-hoc-servers">5. Ad-hoc Servers</a></nav>
      </div>
    </main>
  </div>
  <script>

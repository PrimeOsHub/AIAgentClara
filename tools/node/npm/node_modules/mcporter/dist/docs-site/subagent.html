...
<head>
  ...
  <title>Claude Subagent Quickstart — mcporter</title>
  <meta name="description" content="Claude Subagent Quickstart — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/subagent.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Claude Subagent Quickstart — mcporter">
  <meta property="og:description" content="Claude Subagent Quickstart — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/subagent.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Claude Subagent Quickstart — mcporter">
  <meta name="twitter:description" content="Claude Subagent Quickstart — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link active" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Agents</p>
          <h1>Claude Subagent Quickstart</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/subagent.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="claude-subagent-quickstart">Claude Subagent Quickstart</h1>
<h2 id="cli-basics"><a class="anchor" href="#cli-basics" aria-label="Anchor link">#</a>CLI Basics</h2>
<ul>
<li>Never invoke subagents through <code>./runner</code>—launch them inside tmux directly so the session can persist and bypass the runner timeouts. Example:</li>
</ul>
<p>``<code>bash tmux new-session -d -s claude-haiku &#39;claude --model haiku&#39; tmux attach -t claude-haiku </code>``</p>
<p>Once inside the session, run <code>/model</code> to confirm the active alias (<code>haiku</code> maps to Claude 3.5 Haiku) and switch models if needed.</p>
<ul>
<li>Need to queue instructions without attaching? Use <code>bun scripts/agent-send.ts --session &lt;name&gt; -- &quot;your command&quot;</code> to inject text into a running agent session (single Enter is sent by default).</li>
<li>Run Claude through the repo wrapper when you just need help (<code>./runner claude --help</code>), but for actual delegation launch Claude inside tmux so the work keeps running after you disconnect.</li>
<li>Two modes:</li>
<li>Always switch to the fast Haiku model upfront (<code>claude --model haiku --dangerously-skip-permissions …</code> or <code>/model haiku</code> in-session); it keeps turnaround under the runner’s limits.</li>
<li>Two modes:</li>
<li><strong>One-shot tasks</strong> (single summary, short answer): run <code>claude --model haiku --dangerously-skip-permissions --print …</code> in a tmux session, wait with <code>sleep 30</code>, then read the output buffer.</li>
<li><strong>Interactive tasks</strong> (multi-file edits, iterative prompts): start <code>claude --model haiku --dangerously-skip-permissions</code> in tmux, send prompts with <code>tmux send-keys</code>, and capture completed responses with <code>tmux capture-pane</code>. Expect to sleep between turns so Haiku can finish before you scrape the pane.</li>
<li>Ralph’s supervisor loop launches Claude the same way (<code>claude --dangerously-skip-permissions &quot;&lt;prompt&gt;&quot;</code>) to keep the tmux automation flowing.</li>
</ul>
<h2 id="one-shot-prompts"><a class="anchor" href="#one-shot-prompts" aria-label="Anchor link">#</a>One-Shot Prompts</h2>
<ul>
<li>The CLI accepts the prompt as a trailing argument in one-shot mode. Multi-line prompts can be piped: <code>echo &quot;...&quot; | ./runner claude --print</code>.</li>
<li>Add <code>--output-format json</code> when you need structured fields (e.g., summary + bullets) for post-processing.</li>
<li>Keep prompts explicit about reading full files: “Read docs/example.md in full and produce a 2–3 sentence summary covering all sections.”</li>
</ul>
<h2 id="bulk-markdown-conversion"><a class="anchor" href="#bulk-markdown-conversion" aria-label="Anchor link">#</a>Bulk Markdown Conversion</h2>
<ul>
<li>Produce the markdown inventory first (<code>pnpm run docs:list</code>) and feed batches of filenames to your Claude session.</li>
<li>For each batch, issue a single instruction like “Rewrite these files with YAML front matter summaries, keep all other content verbatim.” Haiku can loop over multi-file edits when you provide the explicit list.</li>
<li>After Claude reports success, diff each file locally (<code>./runner git diff docs/&lt;file&gt;.md</code>) before moving to the next batch.</li>
</ul>
<h2 id="ralph-integration-notes"><a class="anchor" href="#ralph-integration-notes" aria-label="Anchor link">#</a>Ralph Integration Notes</h2>
<ul>
<li>Ralph (see <code>scripts/ralph.ts</code>) spins up tmux sessions, auto-wakes the worker, and calls Claude as the supervisor via <code>claude --dangerously-skip-permissions</code>.</li>
<li>Supervisor responses must end with either <code>CONTINUE</code>, <code>SEND: &lt;message&gt;</code>, or <code>RESTART</code>; Ralph parses these tokens to decide the next action.</li>
<li>To start Ralph manually: <code>bun scripts/ralph.ts start --goal &quot;…&quot; [--markdown path]</code>. Progress is tracked in <code>.ralph/progress.md</code> by default.</li>
<li>Send ad-hoc instructions to the worker session with <code>bun scripts/ralph.ts send-to-worker -- &quot;your guidance&quot;</code>.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="agent-skills.html"><small>Previous</small><span>Agent Skill Pattern</span></a><a class="page-nav-next" href="RELEASE.html"><small>Next</small><span>Release Checklist</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#cli-basics">CLI Basics</a><a class="toc-l2" href="#one-shot-prompts">One-Shot Prompts</a><a class="toc-l2" href="#bulk-markdown-conversion">Bulk Markdown Conversion</a><a class="toc-l2" href="#ralph-integration-notes">Ralph Integration Notes</a></nav>
      </div>
    </main>
  </div>
  <script>

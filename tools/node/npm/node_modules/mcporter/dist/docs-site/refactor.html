...
<head>
  ...
  <title>Next-Step Refactor Checklist — mcporter</title>
  <meta name="description" content="Next-Step Refactor Checklist — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/refactor.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Next-Step Refactor Checklist — mcporter">
  <meta property="og:description" content="Next-Step Refactor Checklist — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/refactor.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Next-Step Refactor Checklist — mcporter">
  <meta name="twitter:description" content="Next-Step Refactor Checklist — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link active" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Reference</p>
          <h1>Next-Step Refactor Checklist</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/refactor.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="next-step-refactor-checklist">Next-Step Refactor Checklist</h1>
<p>This doc tracks remaining reuse/refactor work now that the original plan is done. Each section lists the goal, why it matters, and the concrete steps/tests needed.</p>
<h2 id="1-shared-tool-schema-cache-completed"><a class="anchor" href="#1-shared-tool-schema-cache-completed" aria-label="Anchor link">#</a>1. Shared Tool Schema Cache <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: <code>generate-cli</code> and <code>emit-ts</code> both fetch &amp; serialize tool schemas</li>
<p>independently (and <code>mcporter list</code> re-parses them too).</p>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Added <code>src/cli/tool-cache.ts</code> with <code>loadToolMetadata()</code> caching tool metadata per runtime/server/options.</li>
<li>Switched <code>mcporter list</code> (single-server path) and <code>emit-ts</code> to consume the helper, so both reuse <code>ToolMetadata</code>.</li>
<li>Added <code>tests/tool-cache.test.ts</code> + updated emit-ts tests to ensure the helper is covered.</li>
</ol>
<ul>
<li><strong>Next</strong>: Consider integrating the cache into <code>generate-cli</code> if we ever reuse runtime instances there.</li>
</ul>
<h2 id="2-unified-flag-parsing-for-generator-style-commands-completed"><a class="anchor" href="#2-unified-flag-parsing-for-generator-style-commands-completed" aria-label="Anchor link">#</a>2. Unified Flag Parsing for Generator-style Commands <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: <code>generate-cli</code>, the (now legacy) <code>regenerate-cli</code> wrapper, and <code>emit-ts</code> each</li>
<p>reimplemented <code>--runtime</code>, <code>--timeout</code>, and <code>--include-optional</code> handling.</p>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Added <code>extractGeneratorFlags()</code> in <code>src/cli/generate/flag-parser.ts</code> to</li>
<p>normalize shared flags while mutating <code>args</code> in place.</p>
<li>Updated all three commands to call the helper before parsing</li>
<p>command-specific options.</p>
<li>Added <code>tests/generator-flag-parser.test.ts</code> to cover runtime/timeout and</li>
<p>optional flags.</p>
</ol>
<h2 id="3-test-fixture-reuse-completed"><a class="anchor" href="#3-test-fixture-reuse-completed" aria-label="Anchor link">#</a>3. Test Fixture Reuse <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: Emit-ts/tool-cache/unit tests each defined their own tool/definition</li>
<p>fixtures, leading to divergence.</p>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Added <code>tests/fixtures/tool-fixtures.ts</code> (shared definition + tools).</li>
<li>Updated <code>tests/emit-ts.test.ts</code> and <code>tests/tool-cache.test.ts</code> to import</li>
<p>the shared fixtures (and reuse them via <code>buildToolMetadata</code>).</p>
<li>Ensured the fixture covers required+optional parameters so both suites hit</li>
<p>the same edge cases.</p>
</ol>
<h2 id="4-callresult-helper-extraction-completed"><a class="anchor" href="#4-callresult-helper-extraction-completed" aria-label="Anchor link">#</a>4. CallResult Helper Extraction <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: <code>call-command.ts</code> and the emit-ts client template both wrapped</li>
<p>results with <code>createCallResult</code>, but there was no shared helper.</p>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Added <code>wrapCallResult()</code> to <code>result-utils.ts</code> and exported it from the</li>
<p>package entry.</p>
<li>Updated <code>call-command.ts</code> and the emit-ts template to reuse the helper so</li>
<p>they stay in sync.</p>
<li>Adjusted emit-ts tests to assert the helper is referenced.</li>
</ol>
<h2 id="5-cli-docs-consolidation-completed"><a class="anchor" href="#5-cli-docs-consolidation-completed" aria-label="Anchor link">#</a>5. CLI Docs Consolidation <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: CLI usage guidance was scattered across README, <code>docs/spec.md</code>,</li>
<p>and various feature docs.</p>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Added <code>docs/cli-reference.md</code> summarizing <code>list</code>, <code>call</code>, <code>generate-cli</code>,</li>
<p>and <code>emit-ts</code> flags/modes in one place.</p>
<li>Pointed emit-ts users to that doc so we can converge other references over</li>
<p>time (no README/spec churn yet to avoid clobbering parallel work).</p>
</ol>
<ul>
<li><strong>Next</strong>: Once the other doc changes land, update README/spec to link to the</li>
<p>reference and drop redundant sections.</p>
</ul>
<h2 id="6-runtime-module-split-completed"><a class="anchor" href="#6-runtime-module-split-completed" aria-label="Anchor link">#</a>6. Runtime Module Split <em>(Completed)</em></h2>
<ul>
<li><strong>Problem</strong>: <code>src/runtime.ts</code> had grown bulky (600+ lines) mixing transport setup, OAuth flow control, and small helpers, making tests and reuse harder.</li>
<li><strong>What we did</strong>:</li>
</ul>
<ol>
<li>Extracted transport construction/retry logic to <code>src/runtime/transport.ts</code>.</li>
<li>Moved OAuth helpers (timeouts, connect retry, errors) to <code>src/runtime/oauth.ts</code> and centralized env-parsed timeouts.</li>
<li>Pulled argument/timeout utilities into <code>src/runtime/utils.ts</code>.</li>
<li>Made reset-policy logic reusable via <code>src/runtime/errors.ts</code>.</li>
<li>Switched tests to import helpers directly instead of using <code>runtime.__test</code>.</li>
<li>Added a targeted transport test to cover SSE fallback and OAuth promotion.</li>
</ol>
<ul>
<li><strong>Next</strong>: Keep new helpers in sync as runtime evolves; prefer adding surface to these modules over growing <code>runtime.ts</code> again.</li>
</ul>
<hr>
<p>Tracking the above here keeps future agents aligned. Update this checklist as items ship (mark sections “Completed” when done, or delete the doc once empty).</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="pnpm-mcp-migration.html"><small>Previous</small><span>Migrating from `pnpm mcp:*`</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#1-shared-tool-schema-cache-completed">1. Shared Tool Schema Cache (Completed)</a><a class="toc-l2" href="#2-unified-flag-parsing-for-generator-style-commands-completed">2. Unified Flag Parsing for Generator-style Commands (Completed)</a><a class="toc-l2" href="#3-test-fixture-reuse-completed">3. Test Fixture Reuse (Completed)</a><a class="toc-l2" href="#4-callresult-helper-extraction-completed">4. CallResult Helper Extraction (Completed)</a><a class="toc-l2" href="#5-cli-docs-consolidation-completed">5. CLI Docs Consolidation (Completed)</a><a class="toc-l2" href="#6-runtime-module-split-completed">6. Runtime Module Split (Completed)</a></nav>
      </div>
    </main>
  </div>
  <script>

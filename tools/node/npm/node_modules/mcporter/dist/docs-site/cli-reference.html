...
<head>
  ...
  <title>mcporter CLI Reference — mcporter</title>
  <meta name="description" content="mcporter CLI Reference — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/cli-reference.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="mcporter CLI Reference — mcporter">
  <meta property="og:description" content="mcporter CLI Reference — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/cli-reference.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="mcporter CLI Reference — mcporter">
  <meta name="twitter:description" content="mcporter CLI Reference — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link active" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">CLI</p>
          <h1>mcporter CLI Reference</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/cli-reference.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="mcporter-cli-reference">mcporter CLI Reference</h1>
<p>A quick reference for the primary <code>mcporter</code> subcommands. Each command inherits <code>--config &lt;file&gt;</code> and <code>--root &lt;dir&gt;</code> to override where servers are loaded from.</p>
<h2 id="mcporter-list-server"><a class="anchor" href="#mcporter-list-server" aria-label="Anchor link">#</a><code>mcporter list [server]</code></h2>
<ul>
<li>Without arguments, lists every configured server (with live discovery + brief</li>
<p>status).</p>
<li>With a server name, prints TypeScript-style signatures for each tool, doc</li>
<p>comments, optional summaries, and any server <code>instructions</code> returned during MCP initialization.</p>
<li>With <code>server.tool</code>, prints just that tool; combine with <code>--schema</code> for a single</li>
<p>tool schema.</p>
<li>Add <code>--brief</code> or <code>--signatures</code> with a server or <code>server.tool</code> target to keep</li>
<p>the server header/instructions and print compact signatures without doc comments, examples, or schemas.</p>
<li>Hidden alias: <code>list-tools</code> (kept for muscle memory; not advertised in help output).</li>
<li>Hidden ad-hoc flag aliases: <code>--sse</code> for <code>--http-url</code>, <code>--insecure</code> for <code>--allow-http</code> (for plain HTTP testing).</li>
<li>Flags:</li>
<li><code>--brief</code> – compact single-server output; cannot be combined with <code>--json</code>,</li>
<p><code>--schema</code>, <code>--verbose</code>, or <code>--all-parameters</code>.</p>
<li><code>--signatures</code> – alias for <code>--brief</code>.</li>
<li><code>--all-parameters</code> – include every optional parameter in the signature.</li>
<li><code>--schema</code> – pretty-print the JSON schema for each tool.</li>
<li><code>--timeout &lt;ms&gt;</code> – per-server timeout when enumerating all servers.</li>
</ul>
<h2 id="mcporter-call-server-tool"><a class="anchor" href="#mcporter-call-server-tool" aria-label="Anchor link">#</a><code>mcporter call &lt;server.tool&gt;</code></h2>
<ul>
<li>Invokes a tool once and prints the response; supports positional arguments via</li>
<p>pseudo-TS syntax and <code>--arg</code> flags.</p>
<li>Useful flags:</li>
<li><code>--server</code>, <code>--tool</code> – alternate way to target a tool.</li>
<li><code>--</code> – stop flag parsing so remaining tokens stay literal positional values.</li>
<li><code>--timeout &lt;ms&gt;</code> – override call timeout (defaults to <code>CALL_TIMEOUT_MS</code>).</li>
<li><code>--output text|markdown|json|raw</code> – choose how to render the <code>CallResult</code>.</li>
<li><code>--save-images &lt;dir&gt;</code> – persist image content blocks to files under the specified directory.</li>
<li><code>--raw-strings</code> – disable numeric coercion for flag-style and positional values.</li>
<li><code>--no-coerce</code> – disable all flag-style/positional value coercion.</li>
<li><code>--tail-log</code> – stream tail output when the tool returns log handles.</li>
</ul>
<h2 id="mcporter-resource-server-uri"><a class="anchor" href="#mcporter-resource-server-uri" aria-label="Anchor link">#</a><code>mcporter resource &lt;server&gt; [uri]</code></h2>
<ul>
<li>Lists resources exposed by a server when no URI is provided.</li>
<li>Reads an MCP resource when <code>uri</code> is provided and renders text, markdown, JSON,</li>
<p>or raw output using the same output formatter as <code>mcporter call</code>.</p>
<li>Hidden alias: <code>resources</code>.</li>
<li>Useful flags:</li>
<li><code>--output auto|text|markdown|json|raw</code> – choose how to render the response.</li>
<li><code>--json</code> – shortcut for <code>--output json</code>.</li>
<li><code>--raw</code> – shortcut for <code>--output raw</code>.</li>
</ul>
<h2 id="mcporter-serve-servers-a-b-c-stdio-http-port"><a class="anchor" href="#mcporter-serve-servers-a-b-c-stdio-http-port" aria-label="Anchor link">#</a><code>mcporter serve [--servers a,b,c] [--stdio | --http &lt;port&gt;]</code></h2>
<ul>
<li>Exposes daemon-managed keep-alive servers as one MCP server for clients that</li>
<p>consume MCP over stdio or Streamable HTTP.</p>
<li><code>tools/list</code> queries the daemon for each selected server and publishes tools</li>
<p>as <code>server__tool</code>; <code>tools/call</code> strips the prefix and routes the call through the daemon.</p>
<li>Only configured keep-alive servers participate. Add</li>
<p><code>&quot;lifecycle&quot;: &quot;keep-alive&quot;</code> to a server definition when you want it managed by the daemon.</p>
<li>Flags:</li>
<li><code>--stdio</code> – serve MCP over stdio; this is the default and is the mode to</li>
<p>register with Claude Code, Codex, and similar clients.</p>
<li><code>--http &lt;port&gt;</code> – serve MCP Streamable HTTP on <code>/mcp</code>, bound to</li>
<p><code>127.0.0.1</code> by default.</p>
<li><code>--host &lt;host&gt;</code> – override the HTTP bind host when you intentionally need a</li>
<p>non-local listener.</p>
<li><code>--servers &lt;csv&gt;</code> – expose only the listed keep-alive server names.</li>
</ul>
<h2 id="mcporter-generate-cli"><a class="anchor" href="#mcporter-generate-cli" aria-label="Anchor link">#</a><code>mcporter generate-cli</code></h2>
<ul>
<li>Produces a standalone CLI for a single MCP server (optionally bundling or</li>
<p>compiling with Bun).</p>
<li>Key flags:</li>
<li><code>--server &lt;name&gt;</code> (or inline JSON) – choose the server definition.</li>
<li><code>--command &lt;url|command&gt;</code> – point at an ad-hoc HTTP endpoint (include <code>https://</code> or use <code>host/path.tool</code>) or a stdio command (anything with spaces, e.g., <code>&quot;npx -y chrome-devtools-mcp@latest&quot;</code>). If you omit <code>--command</code>, the first positional argument is inspected: whitespace → stdio, otherwise the parser probes for HTTP/HTTPS and falls back to config names.</li>
<li><code>--output &lt;path&gt;</code> – where to write the TypeScript template.</li>
<li><code>--bundle &lt;path&gt;</code> – emit a bundle (Node/Bun) ready for <code>bun x</code>.</li>
<li><code>--bundler rolldown|bun</code> – pick the bundler implementation (defaults to Rolldown unless the runtime resolves to Bun, in which case Bun’s bundler is used automatically; still requires a local Bun install).</li>
<li><code>--compile &lt;path&gt;</code> – compile with Bun (implies <code>--runtime bun</code>).</li>
<li><code>--include-tools &lt;a,b,c&gt;</code> – only generate subcommands for the specified tools (exact MCP tool names). It is an error if any requested tool is missing.</li>
<li><code>--exclude-tools &lt;a,b,c&gt;</code> – generate subcommands for every tool except the ones listed. Unknown tool names are ignored. If all tools are excluded, generation fails.</li>
<li><code>--include-tools</code> and <code>--exclude-tools</code> are mutually exclusive.</li>
<li><code>--timeout &lt;ms&gt;</code> / <code>--runtime node|bun</code> – shared via the generator flag</li>
<p>parser so defaults stay consistent.</p>
<li><code>--from &lt;artifact&gt;</code> – reuse metadata from an existing CLI artifact (legacy</li>
<p><code>regenerate-cli</code> behavior, must point at an existing CLI).</p>
<li><code>--dry-run</code> – print the resolved <code>mcporter generate-cli ...</code> command without</li>
<p>executing (requires <code>--from</code>).</p>
<li>Positional shorthand: <code>npx mcporter generate-cli linear</code> uses the configured</li>
<p><code>linear</code> definition; <code>npx mcporter generate-cli https://example.com/mcp</code> treats the URL as an ad-hoc server definition.</p>
</ul>
<h2 id="mcporter-emit-ts-server"><a class="anchor" href="#mcporter-emit-ts-server" aria-label="Anchor link">#</a><code>mcporter emit-ts &lt;server&gt;</code></h2>
<ul>
<li>Emits TypeScript definitions (and optionally a ready-to-use client) describing</li>
<p>a server’s tools. This reuses the same formatter as <code>mcporter list</code> so doc comments, signatures, and examples stay in sync.</p>
<li>Modes:</li>
<li><code>--mode types --out &lt;file.d.ts&gt;</code> (default) – export an interface whose</li>
<p>methods return <code>Promise&lt;CallResult&gt;</code>, with doc comments and optional summaries.</p>
<li><code>--mode client --out &lt;file.ts&gt;</code> – emit both the interface (<code>&lt;file&gt;.d.ts</code>)</li>
<p>and a factory that wraps <code>createServerProxy</code>, returning objects whose methods resolve to <code>CallResult</code>.</p>
<li>Other flags:</li>
<li><code>--include-optional</code> (alias <code>--all-parameters</code>) – show every optional field.</li>
<li><code>--types-out &lt;file&gt;</code> – override where the <code>.d.ts</code> sits when using client</li>
<p>mode.</p>
</ul>
<p>For more detail (behavioral nuances, OAuth flows, etc.), see <code>docs/spec.md</code> and command-specific docs under <code>docs/</code>.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="config.html"><small>Previous</small><span>CLI Help Menu Snapshot</span></a><a class="page-nav-next" href="call-syntax.html"><small>Next</small><span>Call Syntax Reference</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#mcporter-list-server">mcporter list [server]</a><a class="toc-l2" href="#mcporter-call-server-tool">mcporter call &amp;lt;server.tool&amp;gt;</a><a class="toc-l2" href="#mcporter-resource-server-uri">mcporter resource &amp;lt;server&amp;gt; [uri]</a><a class="toc-l2" href="#mcporter-serve-servers-a-b-c-stdio-http-port">mcporter serve [--servers a,b,c] [--stdio | --http &amp;lt;port&amp;gt;]</a><a class="toc-l2" href="#mcporter-generate-cli">mcporter generate-cli</a><a class="toc-l2" href="#mcporter-emit-ts-server">mcporter emit-ts &amp;lt;server&amp;gt;</a></nav>
      </div>
    </main>
  </div>
  <script>

...
<head>
  ...
  <title>Call Command Auto-Correction — mcporter</title>
  <meta name="description" content="Call Command Auto-Correction — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/call-heuristic.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Call Command Auto-Correction — mcporter">
  <meta property="og:description" content="Call Command Auto-Correction — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/call-heuristic.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Call Command Auto-Correction — mcporter">
  <meta name="twitter:description" content="Call Command Auto-Correction — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link active" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">CLI</p>
          <h1>Call Command Auto-Correction</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/call-heuristic.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="call-command-auto-correction">Call Command Auto-Correction</h1>
<p><code>mcporter call</code> aims to help when a tool name is <em>almost</em> correct without hiding real mistakes.</p>
<h2 id="confident-matches-auto-correct"><a class="anchor" href="#confident-matches-auto-correct" aria-label="Anchor link">#</a>Confident Matches → Auto-Correct</h2>
<ul>
<li>We normalise tool names (strip punctuation, lowercase) and compute a Levenshtein distance.</li>
<li>If the distance is ≤ <code>max(2, floor(length × 0.3))</code>, or the names only differ by case/punctuation, we retry automatically.</li>
<li>A dim informational line explains the correction: <code>[mcporter] Auto-corrected tool call to linear.list_issues (input: linear.listIssues).</code></li>
</ul>
<h2 id="low-confidence-matches-suggest"><a class="anchor" href="#low-confidence-matches-suggest" aria-label="Anchor link">#</a>Low-Confidence Matches → Suggest</h2>
<ul>
<li>When the best candidate falls outside the threshold we keep the original failure.</li>
<li>We still print a hint so the user learns the canonical name: <code>[mcporter] Did you mean linear.list_issue_statuses?</code></li>
<li>No second call is attempted in this case.</li>
</ul>
<h2 id="edge-cases"><a class="anchor" href="#edge-cases" aria-label="Anchor link">#</a>Edge Cases</h2>
<ul>
<li>We only inspect the tool catalog if the server explicitly replied with “Tool … not found”. Other MCP errors surface untouched.</li>
<li>If listing tools itself fails (auth, offline, etc.) we skip both auto-correct and hints.</li>
<li>Behaviour is covered by <code>tests/cli-call.test.ts</code>.</li>
</ul>
<h2 id="server-selection-heuristic"><a class="anchor" href="#server-selection-heuristic" aria-label="Anchor link">#</a>Server Selection Heuristic</h2>
<ul>
<li><code>mcporter list &lt;server&gt;</code> now applies the same edit-distance heuristic to server names. If you type <code>vercek</code>, the CLI auto-corrects to <code>vercel</code> (and logs <code>[mcporter] Auto-corrected server name to vercel (input: vercek).</code>).</li>
<li>When the typo is too large, we keep the original failure but emit a hint: <code>[mcporter] Did you mean linear?</code> followed by the usual “Unknown MCP server …” line. This avoids giant stack traces while pointing to the right name.</li>
<li>The heuristic considers every configured server (including ad-hoc ones registered via <code>--http-url/--stdio</code>). Tests covering this behaviour live in <code>tests/cli-list.test.ts</code>.</li>
<li><code>mcporter auth</code> shares the same routing logic, so <code>mcporter auth https://mcp.example.com/mcp</code> (or even <code>mcporter auth vercek</code>) will spin up the temporary definition, auto-correct close names, and launch OAuth without touching the config file.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="call-syntax.html"><small>Previous</small><span>Call Syntax Reference</span></a><a class="page-nav-next" href="shortcuts.html"><small>Next</small><span>Agent Shortcuts</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#confident-matches-auto-correct">Confident Matches → Auto-Correct</a><a class="toc-l2" href="#low-confidence-matches-suggest">Low-Confidence Matches → Suggest</a><a class="toc-l2" href="#edge-cases">Edge Cases</a><a class="toc-l2" href="#server-selection-heuristic">Server Selection Heuristic</a></nav>
      </div>
    </main>
  </div>
  <script>

...
<head>
  ...
  <title>Live MCP Tests — mcporter</title>
  <meta name="description" content="Live MCP Tests — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/livetests.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Live MCP Tests — mcporter">
  <meta property="og:description" content="Live MCP Tests — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/livetests.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Live MCP Tests — mcporter">
  <meta name="twitter:description" content="Live MCP Tests — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link active" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>Live MCP Tests</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/livetests.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="live-mcp-tests">Live MCP Tests</h1>
<p>These tests hit real hosted MCP servers and require outbound HTTP. They are <strong>off by default</strong> to keep CI and local runs deterministic.</p>
<h2 id="when-to-run"><a class="anchor" href="#when-to-run" aria-label="Anchor link">#</a>When to run</h2>
<ul>
<li>Before releases when you want end-to-end validation against hosted servers.</li>
<li>When debugging regressions that only repro against real servers (e.g., DeepWiki).</li>
</ul>
<h2 id="how-to-run"><a class="anchor" href="#how-to-run" aria-label="Anchor link">#</a>How to run</h2>
<pre><code class="language-bash">MCP_LIVE_TESTS=1 pnpm test:live</code></pre>
<p>This runs the Vitest suite under <code>tests/live</code>, in-band, with longer timeouts.</p>
<h2 id="current-coverage"><a class="anchor" href="#current-coverage" aria-label="Anchor link">#</a>Current coverage</h2>
<ul>
<li><strong>DeepWiki</strong>:</li>
<li>Streamable HTTP success path: <code>https://mcp.deepwiki.com/mcp</code></li>
<li>Deprecated SSE endpoint classification: <code>https://mcp.deepwiki.com/sse</code></li>
<li>Tests:</li>
<li>call <code>read_wiki_structure repoName:facebook/react</code> and assert a non-empty result over Streamable HTTP</li>
<li>assert the legacy SSE endpoint currently returns a structured HTTP <code>410</code> issue envelope</li>
</ul>
<h2 id="notes"><a class="anchor" href="#notes" aria-label="Anchor link">#</a>Notes</h2>
<ul>
<li>Tests are skipped entirely unless <code>MCP_LIVE_TESTS=1</code> is set.</li>
<li>Ensure network egress is allowed. No secrets are required for the current DeepWiki checks.</li>
<li>As of 2026-03-29, DeepWiki&#39;s hosted <code>/sse</code> endpoint responds with HTTP <code>410</code>, so the live suite treats that as a compatibility/error-classification smoke rather than a success-path transport check.</li>
<li>Keep assertions minimal to reduce flake; these are availability smokes, not full contract tests.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="manual-testing.html"><small>Previous</small><span>Manual Testing Harness</span></a><a class="page-nav-next" href="hang-debug.html"><small>Next</small><span>Debugging Hanging mcporter Calls</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#when-to-run">When to run</a><a class="toc-l2" href="#how-to-run">How to run</a><a class="toc-l2" href="#current-coverage">Current coverage</a><a class="toc-l2" href="#notes">Notes</a></nav>
      </div>
    </main>
  </div>
  <script>

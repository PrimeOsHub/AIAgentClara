...
<head>
  ...
  <title>Manual Testing Harness — mcporter</title>
  <meta name="description" content="Manual Testing Harness — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/manual-testing.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Manual Testing Harness — mcporter">
  <meta property="og:description" content="Manual Testing Harness — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/manual-testing.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Manual Testing Harness — mcporter">
  <meta name="twitter:description" content="Manual Testing Harness — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link active" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>Manual Testing Harness</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/manual-testing.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="manual-testing-harness">Manual Testing Harness</h1>
<p>When we need to sanity-check CLI flows against real MCP servers (or reproduce bugs by hand), use this repeatable harness. Everything runs under <code>tmux</code> so long-running commands can be inspected without blocking the current shell.</p>
<h2 id="prerequisites"><a class="anchor" href="#prerequisites" aria-label="Anchor link">#</a>Prerequisites</h2>
<ul>
<li><code>pnpm install</code> ran recently.</li>
<li>Credentials exist for any auth-required servers you plan to exercise.</li>
<li><code>tmux</code> is installed (we rely on it below).</li>
</ul>
<h2 id="discover-live-servers"><a class="anchor" href="#discover-live-servers" aria-label="Anchor link">#</a>Discover live servers</h2>
<p>Start every session by listing all configured servers so you can pick a healthy target:</p>
<pre><code class="language-bash">tmux new-session -d -s list-all &#39;pnpm exec tsx src/cli.ts list --timeout 1000 &gt; /tmp/list-all.log 2&gt;&amp;1; sleep 5&#39;
sleep 2
cat /tmp/list-all.log</code></pre>
<p>The summary shows which servers are healthy, require auth, or are offline. Choose one of the &quot;healthy&quot; entries (e.g., <code>shadcn</code>, <code>firecrawl</code>, <code>obsidian-mcp-tools</code>) for the manual checks below.</p>
<h2 id="test-matrix"><a class="anchor" href="#test-matrix" aria-label="Anchor link">#</a>Test matrix</h2>
<p>For each server under test, run the following commands, adjusting <code>SERVER</code>, <code>TOOL</code>, and arguments as needed. Each command writes to <code>/tmp</code> so logs are easy to share.</p>
<h3 id="list-command"><a class="anchor" href="#list-command" aria-label="Anchor link">#</a>List command</h3>
<pre><code class="language-bash">tmux new-session -d -s list-SERVER \
  &#39;pnpm exec tsx src/cli.ts list SERVER --timeout 2000 &gt; /tmp/list-SERVER.log 2&gt;&amp;1; sleep 5&#39;
sleep 2
cat /tmp/list-SERVER.log</code></pre>
<p>Verify:</p>
<ul>
<li>Header shows the right name/transport and the new metadata line (<code>tools · duration · transport</code>).</li>
<li>Timeouts produce the footer block: <code>Tools: &lt;timed out after ...&gt;</code> and <code>Reason: ...</code>.</li>
</ul>
<h3 id="call-command"><a class="anchor" href="#call-command" aria-label="Anchor link">#</a>Call command</h3>
<pre><code class="language-bash">tmux new-session -d -s call-SERVER \
  &#39;pnpm exec tsx src/cli.ts call SERVER.toolName key=value --timeout 2000 &gt; /tmp/call-SERVER.log 2&gt;&amp;1; sleep 5&#39;
sleep 2
cat /tmp/call-SERVER.log</code></pre>
<p>Checks:</p>
<ul>
<li>Successful calls print the payload; failures reuse the shared hinting (<code>SSE error ...</code>, auto-correct messages, etc.).</li>
<li>For HTTP selectors (<code>https://.../mcp.tool</code> or <code>https://.../mcp.tool(args)</code>), ensure no OAuth prompt appears and the request hits the configured server.</li>
</ul>
<h3 id="auth-command"><a class="anchor" href="#auth-command" aria-label="Anchor link">#</a>Auth command</h3>
<p>For OAuth servers:</p>
<pre><code class="language-bash">tmux new-session -d -s auth-SERVER \
  &#39;pnpm exec tsx src/cli.ts auth SERVER --reset &gt; /tmp/auth-SERVER.log 2&gt;&amp;1; sleep 5&#39;
sleep 2
cat /tmp/auth-SERVER.log</code></pre>
<p>Expectations:</p>
<ul>
<li>If a token cache exists, log should mention the cleared directory.</li>
<li>Failed auths emit the unified message (<code>Failed to authorize &#39;SERVER&#39;: ...</code>).</li>
</ul>
<p>For headless OAuth URL capture, run the same auth command with <code>--no-browser</code>:</p>
<ul>
<li>Text mode stdout should contain exactly one authorization URL line and no logger prefix.</li>
<li><code>--json --no-browser</code> stdout should parse as JSON with <code>authorizationUrl</code> and <code>redirectUrl</code>.</li>
<li>If completing the flow from another machine over SSH, forward the printed callback port with a loopback-only tunnel; avoid exposing the callback listener publicly.</li>
<li>Treat copied authorization URLs as sensitive and avoid storing them in long-lived logs.</li>
</ul>
<h2 id="tips"><a class="anchor" href="#tips" aria-label="Anchor link">#</a>Tips</h2>
<ul>
<li>To exercise error paths, point at a placeholder endpoint and use <code>--timeout 1000</code> (e.g., <code>https://example.com/mcp.listStuff</code>).</li>
<li>Kill tmux sessions before reusing a name: <code>tmux kill-session -t session-name</code>.</li>
<li>To watch live output instead of dumping the log at the end, attach via <code>tmux attach -t session-name</code> and detach (<code>Ctrl+B</code>, then <code>D</code>) when done.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="RELEASE.html"><small>Previous</small><span>Release Checklist</span></a><a class="page-nav-next" href="livetests.html"><small>Next</small><span>Live MCP Tests</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#prerequisites">Prerequisites</a><a class="toc-l2" href="#discover-live-servers">Discover live servers</a><a class="toc-l2" href="#test-matrix">Test matrix</a><a class="toc-l3" href="#list-command">List command</a><a class="toc-l3" href="#call-command">Call command</a><a class="toc-l3" href="#auth-command">Auth command</a><a class="toc-l2" href="#tips">Tips</a></nav>
      </div>
    </main>
  </div>
  <script>

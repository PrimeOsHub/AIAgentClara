...
<head>
  ...
  <title>`mcporter emit-ts` — mcporter</title>
  <meta name="description" content="`mcporter emit-ts` — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/emit-ts.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="`mcporter emit-ts` — mcporter">
  <meta property="og:description" content="`mcporter emit-ts` — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/emit-ts.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="`mcporter emit-ts` — mcporter">
  <meta name="twitter:description" content="`mcporter emit-ts` — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link active" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Generators</p>
          <h1>`mcporter emit-ts`</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/emit-ts.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="mcporter-emit-ts"><code>mcporter emit-ts</code></h1>
<p><code>mcporter emit-ts</code> turns a configured MCP server into TypeScript artifacts so agents, tests, and tooling can consume the server through strongly typed APIs. It reuses the same <code>buildToolDoc()</code> data that powers <code>mcporter list</code>, so doc comments, parameter hints, and signatures stay perfectly in sync. For a broader overview of every CLI command, see <code>docs/cli-reference.md</code>.</p>
<pre><code class="language-text">mcporter emit-ts &lt;server&gt; --out linear-client.ts \
  [--mode types|client] \
  [--include-optional]</code></pre>
<ul>
<li><code>--mode types</code> (default) emits a <code>.d.ts</code> interface (<code>LinearTools</code>) with</li>
<p>docblocks + promisified signatures. Missing output schemas fall back to <code>CallResult</code>.</p>
<li><code>--mode client</code> emits both the interface (auto-derived <code>.d.ts</code>) <strong>and</strong> an</li>
<p>executable <code>.ts</code> helper that wraps <code>createServerProxy</code>. Each method returns a <code>CallResult</code>, and the factory exposes a <code>close()</code> helper for runtimes the client creates.</p>
<li><code>--include-optional</code> mirrors <code>mcporter list --all-parameters</code>, ensuring every</li>
<p>parameter is shown even when optional.</p>
</ul>
<p>Outputs overwrite existing files automatically so you can regenerate artifacts whenever the server schema changes.</p>
<h2 id="examples"><a class="anchor" href="#examples" aria-label="Anchor link">#</a>Examples</h2>
<h3 id="1-types-only-header"><a class="anchor" href="#1-types-only-header" aria-label="Anchor link">#</a>1. Types-only header</h3>
<pre><code class="language-text">mcporter emit-ts linear --out types/linear-tools.d.ts</code></pre>
<p>Produces:</p>
<pre><code class="language-ts">import type { CallResult } from &#39;mcporter&#39;;
...
<p>Include the file in your agent/project and you can type-check code like <code>const result = await proxy.list_comments({ issueId: &#39;...&#39; });</code>.</p>
<h3 id="2-client-wrappers"><a class="anchor" href="#2-client-wrappers" aria-label="Anchor link">#</a>2. Client wrappers</h3>
<pre><code class="language-text">mcporter emit-ts linear --mode client --out clients/linear.ts</code></pre>
<p>Generates two files:</p>
<ul>
<li><code>clients/linear.d.ts</code> – same interface as the types-only mode.</li>
<li><code>clients/linear.ts</code> – imports <code>createRuntime</code>, <code>createServerProxy</code>, and</li>
<p><code>createCallResult</code>, then exposes a <code>createLinearClient()</code> factory:</p>
</ul>
<pre><code class="language-ts">const client = await createLinearClient({ configPath: &#39;./mcporter.json&#39; });
const comments = await client.list_comments({ issueId: &#39;LIN-1234&#39; });
console.log(comments.text());
await client.close();</code></pre>
<p>If you pass an existing runtime (<code>{ runtime }</code>), the factory reuses it; the returned object’s <code>close()</code> becomes a no-op.</p>
<h2 id="flags"><a class="anchor" href="#flags" aria-label="Anchor link">#</a>Flags</h2>
<table><thead><tr><th>Flag</th><th>Description</th></tr></thead><tbody><tr><td><code>--out &lt;path&gt;</code></td><td>Required. <code>.d.ts</code> target for <code>types</code>, <code>.ts</code> target for <code>client</code>.</td></tr><tr><td>`--mode types</td><td>client`</td><td>Output kind (defaults to <code>types</code>).</td></tr><tr><td><code>--types-out &lt;path&gt;</code></td><td>Optional override for the <code>.d.ts</code> file when <code>--mode client</code>. Default: derive from <code>--out</code>.</td></tr><tr><td><code>--include-optional</code></td><td>Include every parameter (not just the minimum 5 + required).</td></tr><tr><td><code>--json</code></td><td>Emit a JSON summary describing the emitted file(s) instead of plain-text logs.</td></tr></tbody></table>
<h2 id="testing"><a class="anchor" href="#testing" aria-label="Anchor link">#</a>Testing</h2>
<p><code>tests/emit-ts.test.ts</code> covers:</p>
<ul>
<li>Template rendering (doc comments, <code>Promise&lt;…&gt;</code> return types, proxy wrappers).</li>
<li>End-to-end CLI invocation with a stub runtime, ensuring both <code>.ts</code> and <code>.d.ts</code></li>
<p>files are written successfully.</p>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="cli-generator.html"><small>Previous</small><span>CLI Generator Plan</span></a><a class="page-nav-next" href="tool-calling.html"><small>Next</small><span>Tool Calling Cheatsheet</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#examples">Examples</a><a class="toc-l3" href="#1-types-only-header">1. Types-only header</a><a class="toc-l3" href="#2-client-wrappers">2. Client wrappers</a><a class="toc-l2" href="#flags">Flags</a><a class="toc-l2" href="#testing">Testing</a></nav>
      </div>
    </main>
  </div>
  <script>

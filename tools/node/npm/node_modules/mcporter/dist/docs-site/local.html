...
<head>
  ...
  <title>Running mcporter Locally — mcporter</title>
  <meta name="description" content="Running mcporter Locally — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/local.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Running mcporter Locally — mcporter">
  <meta property="og:description" content="Running mcporter Locally — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/local.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Running mcporter Locally — mcporter">
  <meta name="twitter:description" content="Running mcporter Locally — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link active" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Connecting servers</p>
          <h1>Running mcporter Locally</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/local.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="running-mcporter-locally">Running mcporter Locally</h1>
<p>You don’t need <code>npx</code> every time—here are the three local entry points we use while developing mcporter itself.</p>
<h2 id="1-direct-typescript-entry-no-build-step"><a class="anchor" href="#1-direct-typescript-entry-no-build-step" aria-label="Anchor link">#</a>1. Direct TypeScript entry (no build step)</h2>
<p>All commands can be executed with <code>tsx</code> straight from <code>src/cli.ts</code>:</p>
<pre><code class="language-bash"># list servers (text)
...
# ad-hoc auth
pnpm exec tsx src/cli.ts auth https://mcp.supabase.com/mcp</code></pre>
<p>These invocations match the <code>pnpm mcporter:*</code> scripts and are ideal when you’re iterating on TypeScript without rebuilding.</p>
<h2 id="2-compiled-cli-from-dist"><a class="anchor" href="#2-compiled-cli-from-dist" aria-label="Anchor link">#</a>2. Compiled CLI from <code>dist/</code></h2>
<p>When you want the same behaviour the published package ships with:</p>
<pre><code class="language-bash">pnpm build          # emits dist/...
node dist/cli.js list
node dist/cli.js call chrome-devtools.take_snapshot</code></pre>
<p>Set flags exactly as you would in production:</p>
<pre><code class="language-bash">MCPORTER_DEBUG_HANG=1 node dist/cli.js list
MCPORTER_NO_FORCE_EXIT=1 node dist/cli.js call linear.search_documentation query=&quot;automations&quot;</code></pre>
<h2 id="3-workspace-executables"><a class="anchor" href="#3-workspace-executables" aria-label="Anchor link">#</a>3. Workspace executables</h2>
<p>After <code>pnpm add mcporter</code> in your project (or inside this repo), the shim binaries are available:</p>
<pre><code class="language-bash">pnpm mcporter:list
pnpm mcporter:call context7.query-docs libraryId=/reactjs/react.dev query=hooks</code></pre>
<h2 id="debug-flags-recap"><a class="anchor" href="#debug-flags-recap" aria-label="Anchor link">#</a>Debug flags recap</h2>
<ul>
<li><code>MCPORTER_DEBUG_HANG=1</code> – dumps active handles around shutdown (pairs well with tmux; see <code>docs/hang-debug.md</code>).</li>
<li><code>MCPORTER_NO_FORCE_EXIT=1</code> – keeps the process alive even after cleanup (useful while inspecting debug output).</li>
<li><code>MCPORTER_FORCE_EXIT=1</code> – force termination even if the above is set.</li>
<li><code>MCPORTER_STDIO_LOGS=1</code> – print the buffered stderr output from stdio MCP servers (handy when debugging noisy backends).</li>
</ul>
<p>All three entry points honour the same <code>--config</code>, <code>--root</code>, and <code>--log-level</code> flags as the published CLI.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="import.html"><small>Previous</small><span>Import Reference</span></a><a class="page-nav-next" href="daemon.html"><small>Next</small><span>MCPorter Daemon Plan</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#1-direct-typescript-entry-no-build-step">1. Direct TypeScript entry (no build step)</a><a class="toc-l2" href="#2-compiled-cli-from-dist">2. Compiled CLI from dist/</a><a class="toc-l2" href="#3-workspace-executables">3. Workspace executables</a><a class="toc-l2" href="#debug-flags-recap">Debug flags recap</a></nav>
      </div>
    </main>
  </div>
  <script>

...
<head>
  ...
  <title>Agent Shortcuts — mcporter</title>
  <meta name="description" content="Agent Shortcuts — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/shortcuts.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Agent Shortcuts — mcporter">
  <meta property="og:description" content="Agent Shortcuts — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/shortcuts.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Agent Shortcuts — mcporter">
  <meta name="twitter:description" content="Agent Shortcuts — mcporter documentation.">
    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/shortcuts.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="agent-shortcuts">Agent Shortcuts</h1>
<p>These undocumented shortcuts are safe for MCP agents to call when they need a quick description of a server or its tools without memorizing the full <code>mcporter</code> CLI surface.</p>
<h2 id="pnpm-mcp-call-server-help"><a class="anchor" href="#pnpm-mcp-call-server-help" aria-label="Anchor link">#</a><code>pnpm mcp call &lt;server&gt;.help</code></h2>
<ul>
<li>Alias for <code>pnpm mcporter:call &lt;server&gt;.help</code>, meant for agents that already rely on the old <code>pnpm mcp:*</code> helpers.</li>
<li>If <code>&lt;server&gt;</code> exposes a <code>help</code> tool, the call behaves exactly like any other tool invocation and streams the tool&#39;s content.</li>
<li>When no <code>help</code> tool exists, the CLI automatically falls back to <code>mcporter list &lt;server&gt;</code> so the agent still sees the server summary, tool signatures, and copy-pasteable examples.</li>
<li>Use <code>--output json</code> if the agent prefers machine-readable summaries; the fallback will mirror that flag.</li>
</ul>
<h2 id="mcporter-describe-server"><a class="anchor" href="#mcporter-describe-server" aria-label="Anchor link">#</a><code>mcporter describe &lt;server&gt;</code></h2>
<ul>
<li>Hidden synonym for <code>mcporter list &lt;server&gt;</code>; it prints the same schema-rich output without teaching agents about the <code>list</code> verb.</li>
<li>Works with any selector the <code>list</code> command accepts (configured names, ad-hoc <code>https://</code> URLs, or <code>--stdio/--http-url</code> flags).</li>
<li>Pair with <code>--schema</code> or <code>--all-parameters</code> when an agent needs the full JSON Schema for every tool.</li>
</ul>
<h3 id="recommended-usage"><a class="anchor" href="#recommended-usage" aria-label="Anchor link">#</a>Recommended Usage</h3>
<ol>
<li>Agents wanting prose guidance should run <code>pnpm mcp call chrome-devtools.help</code>.</li>
<li>If the server lacks a <code>help</code> tool, the command emits a dim hint and then shows the <code>describe</code>/<code>list</code> output so the agent still learns about the server.</li>
<li>For a guaranteed TypeScript-style summary, skip straight to <code>mcporter describe chrome-devtools --schema</code>.</li>
<li>Need the tool menu immediately? Call <code>pnpm mcp call chrome-devtools.list_tools</code>—it’s a shortcut for <code>mcporter list chrome-devtools</code>.</li>
</ol>
<blockquote><p>Note: <code>chrome-devtools</code> currently ships without a <code>help</code> tool, so step 1 always triggers the fallback and prints the same schema-rich output you would see from <code>mcporter list</code>.</p></blockquote><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="call-heuristic.html"><small>Previous</small><span>Call Command Auto-Correction</span></a><a class="page-nav-next" href="logging.html"><small>Next</small><span>Logging &amp; Diagnostics</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#pnpm-mcp-call-server-help">pnpm mcp call &amp;lt;server&amp;gt;.help</a><a class="toc-l2" href="#mcporter-describe-server">mcporter describe &amp;lt;server&amp;gt;</a><a class="toc-l3" href="#recommended-usage">Recommended Usage</a></nav>
      </div>
    </main>
  </div>
  <script>

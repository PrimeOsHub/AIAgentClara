...
<head>
  ...
  <title>OAuth Notes &amp; Hosted MCP Compatibility — mcporter</title>
  <meta name="description" content="OAuth Notes &amp; Hosted MCP Compatibility — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/supabase-auth-issue.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="OAuth Notes &amp; Hosted MCP Compatibility — mcporter">
  <meta property="og:description" content="OAuth Notes &amp; Hosted MCP Compatibility — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/supabase-auth-issue.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="OAuth Notes &amp; Hosted MCP Compatibility — mcporter">
  <meta name="twitter:description" content="OAuth Notes &amp; Hosted MCP Compatibility — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link active" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>OAuth Notes &amp; Hosted MCP Compatibility</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/supabase-auth-issue.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="oauth-notes-hosted-mcp-compatibility">OAuth Notes &amp; Hosted MCP Compatibility</h1>
<h2 id="mcp-spec-expectations"><a class="anchor" href="#mcp-spec-expectations" aria-label="Anchor link">#</a>MCP Spec Expectations</h2>
<ul>
<li>The June 18 2025 MCP “Authorization” spec (and the linked OAuth flow document) requires OAuth 2.1 dynamic client registration plus RFC 7235 <code>WWW-Authenticate</code> challenges for scope negotiation.</li>
<li>Servers SHOULD expose discovery metadata via <code>/.well-known/oauth-authorization-server</code> and <code>/.well-known/oauth-protected-resource</code>. Those documents list supported scopes and additional OAuth endpoints.</li>
<li>Clients are expected to start with a baseline scope (the spec uses <code>mcp:tools</code>) and then re-authenticate with any server-supplied scope hints.</li>
</ul>
<p>We currently hard-code <code>mcp:tools</code> because it is the only scope guaranteed to exist in the MCP reference implementation. We need richer negotiation to support providers that enforce product-specific scopes.</p>
<h2 id="hosted-supabase-mcp-oct-2025"><a class="anchor" href="#hosted-supabase-mcp-oct-2025" aria-label="Anchor link">#</a>Hosted Supabase MCP (~Oct 2025)</h2>
<p>Supabase’s hosted MCP server (<code>https://mcp.supabase.com/mcp</code>) validates the requested scopes against their management API permissions (<code>organizations:read</code>, <code>projects:read</code>, <code>database:write</code>, <code>storage:read</code>, etc.). When mcporter asks for <code>mcp:tools</code>, their authorization server rejects the request with HTTP 400 and a body similar to:</p>
<pre><code class="language-text">{&quot;message&quot;:&quot;scope.0: Invalid enum value. Expected &#39;organizations:read&#39; | &#39;projects:read&#39; | &#39;projects:write&#39; | &#39;database:write&#39; | &#39;database:read&#39; | &#39;analytics:read&#39; | &#39;secrets:read&#39; | &#39;edge_functions:read&#39; | &#39;edge_functions:write&#39; | &#39;environment:read&#39; | &#39;environment:write&#39; | &#39;storage:read&#39;, received &#39;mcp:tools&#39;&quot;}</code></pre>
<p>Key takeaways from Supabase’s docs:</p>
<ol>
<li>Hosted installs rely on dynamic client registration and are currently integrated with Cursor/Windsurf (which embed the Supabase scope list).</li>
<li>Manual authentication is offered for self-hosted/CI workflows (PAT headers or custom OAuth app), but their hosted server still expects Supabase-specific scopes.</li>
<li>There is no public metadata endpoint describing those scopes, so third-party MCP clients cannot opt in automatically.</li>
</ol>
<h2 id="mcporter-s-current-behavior"><a class="anchor" href="#mcporter-s-current-behavior" aria-label="Anchor link">#</a>mcporter’s Current Behavior</h2>
<ul>
<li>We auto-promote ad-hoc HTTP servers to OAuth and retry once when we see 401/403 errors.</li>
<li>We surface any server-supplied OAuth error payload so it’s obvious whether the problem is scope-related, a missing token, etc.</li>
<li>After the second failure we stop retrying to avoid infinite loops.</li>
</ul>
<p>This works for providers that use standard MCP scopes (e.g., the MCP example server, Vercel’s MCP), but it fails for Supabase because they reject <code>mcp:tools</code> outright.</p>
<h2 id="roadmap-proposed-improvements"><a class="anchor" href="#roadmap-proposed-improvements" aria-label="Anchor link">#</a>Roadmap / Proposed Improvements</h2>
<ol>
<li><strong>Scope discovery &amp; negotiation</strong></li>
</ol>
<ul>
<li>Fetch <code>/.well-known/oauth-protected-resource</code> and <code>/.well-known/oauth-authorization-server</code> when a server advertises OAuth. If <code>scopes_supported</code> is present, intersect it with user overrides and use that list instead of <code>mcp:tools</code>.</li>
<li>Parse <code>WWW-Authenticate</code> challenges on 401/403 responses and restart the authorization flow with the scopes the server demands.</li>
</ul>
<ol>
<li><strong>User overrides</strong></li>
</ol>
<ul>
<li>Add CLI/env controls (<code>--oauth-scope</code>, <code>MCPORTER_OAUTH_SCOPES</code>) so users can manually supply provider-specific scope strings (comma-separated) when the server doesn’t expose metadata.</li>
<li>Persist these overrides in the server definition (especially for <code>--persist</code> ad-hoc runs) so future calls reuse the negotiated scope list.</li>
</ul>
<ol>
<li><strong>Better errors &amp; docs</strong></li>
</ol>
<ul>
<li>When the server rejects <code>mcp:tools</code>, suggest either setting custom scopes or following the provider’s manual-auth instructions (e.g., Supabase’s PAT flow).</li>
<li>Link CLI errors to this document so users understand whether the limitation is on our side or the provider’s.</li>
</ul>
<ol>
<li><strong>Provider outreach</strong></li>
</ol>
<ul>
<li>File upstream issues (e.g., Supabase) requesting support for standard MCP scopes or publication of <code>scopes_supported</code> metadata, so we can integrate without custom code.</li>
</ul>
<h2 id="workarounds-today"><a class="anchor" href="#workarounds-today" aria-label="Anchor link">#</a>Workarounds Today</h2>
<ul>
<li>Use a supported GUI client (Cursor, Claude Desktop, Windsurf) for Supabase’s hosted MCP—they already ship the necessary scopes.</li>
<li>Self-host Supabase MCP and configure PAT headers or your own OAuth client; you can then relax scope validation to include <code>mcp:tools</code>.</li>
<li>For other providers, consult their docs for discovery metadata. If they list scopes, set them via a future <code>--oauth-scope</code> flag once we implement it (tracked in #TODO).</li>
</ul>
<p>Until Supabase (and other providers with custom scopes) expose metadata or accept the standard scope, mcporter cannot complete their hosted OAuth flow. This is a platform limitation, not a CLI bug.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="known-issues.html"><small>Previous</small><span>Known Issues</span></a><a class="page-nav-next" href="spec.html"><small>Next</small><span>mcporter Roadmap</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#mcp-spec-expectations">MCP Spec Expectations</a><a class="toc-l2" href="#hosted-supabase-mcp-oct-2025">Hosted Supabase MCP (~Oct 2025)</a><a class="toc-l2" href="#mcporter-s-current-behavior">mcporter’s Current Behavior</a><a class="toc-l2" href="#roadmap-proposed-improvements">Roadmap / Proposed Improvements</a><a class="toc-l2" href="#workarounds-today">Workarounds Today</a></nav>
      </div>
    </main>
  </div>
  <script>

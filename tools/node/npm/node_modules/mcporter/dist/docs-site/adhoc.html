...
<head>
  ...
  <title>Ad-hoc MCP Servers — mcporter</title>
  <meta name="description" content="Ad-hoc MCP Servers — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/adhoc.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Ad-hoc MCP Servers — mcporter">
  <meta property="og:description" content="Ad-hoc MCP Servers — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/adhoc.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Ad-hoc MCP Servers — mcporter">
  <meta name="twitter:description" content="Ad-hoc MCP Servers — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link active" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Connecting servers</p>
          <h1>Ad-hoc MCP Servers</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/adhoc.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="ad-hoc-mcp-servers">Ad-hoc MCP Servers</h1>
<p>mcporter is gaining support for &quot;just try it&quot; workflows where you point the CLI at a raw MCP endpoint without first editing a config file. This doc tracks the behavior and heuristics we use to make that experience smooth while keeping the runtime predictable.</p>
<h2 id="entry-points"><a class="anchor" href="#entry-points" aria-label="Anchor link">#</a>Entry Points</h2>
<p>Two new flag sets let you describe a server on the command line:</p>
<ul>
<li><code>mcporter list --http-url https://mcp.linear.app/mcp [--name linear]</code></li>
<li><code>mcporter call --stdio &quot;bun run ./server.ts&quot; --name local-tools</code></li>
</ul>
<p>You can also pass a bare URL as the selector (<code>mcporter list https://mcp.linear.app/mcp</code>) or embed the URL in a <code>call</code> expression (<code>mcporter call &#39;https://mcp.example.com/tools.generate({ topic: &quot;release&quot; })&#39;</code>).</p>
<ul>
<li>Add <code>--json</code> to <code>mcporter list …</code> when you need a machine-readable summary of status counts and per-server failures, use <code>--output json</code>/<code>--output raw</code> with <code>mcporter call</code> to receive structured <code>{ server, tool, issue }</code> envelopes whenever a transport error occurs, and run <code>mcporter auth … --json</code> to capture the same envelope if OAuth or transport setup fails.</li>
</ul>
<h3 id="example-http-ad-hoc-workflow"><a class="anchor" href="#example-http-ad-hoc-workflow" aria-label="Anchor link">#</a>Example: HTTP ad-hoc workflow</h3>
<pre><code class="language-bash"># Inspect the server directly via URL (no config entry needed)
mcporter list &#39;https://mcp.sentry.dev/mcp?agent=1&#39;

# Call a tool by repeating the same URL + tool suffix
mcporter call &#39;https://mcp.sentry.dev/mcp?agent=1.use_sentry(request: &quot;yo whats up&quot;)&#39;</code></pre>
<p>Notice that the second command repeats the URL. Ad-hoc definitions are ephemeral unless you pass <code>--persist</code>, so there is no stored server named <code>mcp-sentry-dev-mcp</code> yet. Reusing the printed slug only works after you persist the definition (see &quot;Naming &amp; Identity&quot; below) or add the server to your config; otherwise keep passing the URL/stdio selector each time.</p>
<h2 id="transport-detection"><a class="anchor" href="#transport-detection" aria-label="Anchor link">#</a>Transport Detection</h2>
<ul>
<li><strong>HTTP(S)</strong>: Providing a URL defaults to the streamable HTTP transport. <code>https://</code> works out of the box; <code>http://</code> requires <code>--allow-http</code> (or the hidden alias <code>--insecure</code>) to acknowledge cleartext traffic. The <code>--sse</code> flag is a hidden alias for <code>--http-url</code> to match older examples. Use repeatable <code>--header KEY=value</code> flags for private servers that require headers such as <code>Authorization</code>, <code>X-API-Key</code>, or tenant selectors.</li>
<li><strong>STDIO</strong>: Supplying <code>--stdio</code> (with a command string) or <code>--stdio-bin</code> (binary + args) selects the stdio transport. Your current shell environment is inherited automatically; use <code>--env KEY=value</code> only when you need to inject/override specific variables (and <code>--cwd</code> to change directories).</li>
<li><strong>Conflict guard</strong>: Passing both URL and stdio flags errors out so we don’t guess.</li>
</ul>
<h2 id="naming-identity"><a class="anchor" href="#naming-identity" aria-label="Anchor link">#</a>Naming &amp; Identity</h2>
<ul>
<li><code>--name</code> wins when provided.</li>
<li>Otherwise we derive a slug:</li>
<li>HTTP: <code>&lt;host&gt;</code> plus a sanitized path fragment (e.g. <code>mcp-linear-app-mcp</code>).</li>
<li>STDIO: executable basename + script (<code>node-singlestep</code>).</li>
<li>Until you persist the definition (via <code>--persist</code>, <code>mcporter config add</code>, etc.), the slug is <strong>only</strong> used as the cache key for OAuth tokens/log prefs—you still need to supply the ad-hoc descriptor (<code>--http-url</code>, <code>--stdio</code>, or bare URL) every time you invoke <code>mcporter list|call|auth</code>.</li>
<li>Once persisted, the slug becomes a normal server name so <code>mcporter call &lt;slug&gt;.tool</code> and <code>mcporter auth &lt;slug&gt;</code> work just like any other configured entry.</li>
<li>If you don’t persist the definition, run <code>mcporter auth https://mcp.linear.app/mcp</code> (or supply <code>--name linear</code> so <code>mcporter auth linear</code> also works) to finish OAuth with the same settings.</li>
</ul>
<p>This name becomes the cache key for OAuth tokens and log preferences, so repeated ad-hoc calls still benefit from credential reuse.</p>
<h2 id="oauth-auto-detection"><a class="anchor" href="#oauth-auto-detection" aria-label="Anchor link">#</a>OAuth Auto-Detection</h2>
<p>Many hosted MCP servers (Supabase, Vercel, etc.) advertise OAuth capabilities but expect clients to discover this dynamically. When an ad-hoc HTTP server responds with <code>401/403</code> during the initial handshake, mcporter now:</p>
<ol>
<li><strong>Promotes the definition to OAuth</strong> and spins up the default browser flow—no need to edit config or supply <code>auth: &quot;oauth&quot;</code> manually. On headless hosts, pass <code>--no-browser</code> (or <code>--browser none</code>) to print the authorization URL instead of launching the platform browser.</li>
<li><strong>Persists the change</strong> whenever you pass <code>--persist</code>, so future runs remember that the endpoint requires OAuth without repeating the detection step.</li>
</ol>
<p>The CLI still avoids surprise prompts during <code>mcporter list</code>; the upgrade happens the first time you run <code>mcporter auth &lt;url&gt;</code> or any other command that allows OAuth (i.e., not in <code>--autoAuthorize=false</code> mode).</p>
<h2 id="auth-persistence"><a class="anchor" href="#auth-persistence" aria-label="Anchor link">#</a>Auth &amp; Persistence</h2>
<ul>
<li>OAuth flows are allowed; successful tokens store under the inferred name just like regular definitions.</li>
<li><code>mcporter auth</code> accepts the same <code>--http-url/--stdio</code> flags (and even bare URLs), so you can immediately re-run <code>mcporter auth https://…</code> after a 401 without touching a config file.</li>
<li>Use <code>mcporter auth &lt;url&gt; --no-browser</code> for human-in-the-loop headless OAuth. Text mode writes only the authorization URL to stdout; <code>--json --no-browser</code> writes <code>authorizationUrl</code> plus <code>redirectUrl</code> as JSON. Keep that URL out of durable CI logs and support bundles.</li>
<li>When opening the URL on a different machine, remember that loopback redirect URLs point at the browser machine unless an SSH tunnel forwards the callback port back to the mcporter process. Use <code>oauthRedirectUrl</code> when you need a predictable callback port.</li>
<li>Nothing is written to disk unless you pass <code>--persist /path/to/config.json</code>. When set, we merge the generated definition into that file (creating it if necessary) so future runs can rely on the standard config pipeline. Ad-hoc HTTP headers are persisted with the entry, so placeholders such as <code>--header &#39;Authorization=$env:MY_TOKEN&#39;</code> keep working through the normal config header resolver.</li>
</ul>
<h2 id="safety-nets"><a class="anchor" href="#safety-nets" aria-label="Anchor link">#</a>Safety Nets</h2>
<ul>
<li>Non-HTTPS endpoints require <code>--allow-http</code>.</li>
<li>For stdio commands we print a confirmation snippet the first time we see a new command unless <code>--yes</code> is present.</li>
<li>Missing transports or malformed combinations throw descriptive errors, pointing to <code>docs/adhoc.md</code> for guidance.</li>
</ul>
<h2 id="follow-ups"><a class="anchor" href="#follow-ups" aria-label="Anchor link">#</a>Follow-ups</h2>
<ul>
<li>Extend <code>mcporter config add</code> to leverage the same helper, making it the one-stop path from exploration to permanence.</li>
<li>Consider caching inference results so repeated URL calls automatically rehydrate the previous settings (env/cwd).</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="tool-calling.html"><small>Previous</small><span>Tool Calling Cheatsheet</span></a><a class="page-nav-next" href="import.html"><small>Next</small><span>Import Reference</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#entry-points">Entry Points</a><a class="toc-l3" href="#example-http-ad-hoc-workflow">Example: HTTP ad-hoc workflow</a><a class="toc-l2" href="#transport-detection">Transport Detection</a><a class="toc-l2" href="#naming-identity">Naming &amp;amp; Identity</a><a class="toc-l2" href="#oauth-auto-detection">OAuth Auto-Detection</a><a class="toc-l2" href="#auth-persistence">Auth &amp;amp; Persistence</a><a class="toc-l2" href="#safety-nets">Safety Nets</a><a class="toc-l2" href="#follow-ups">Follow-ups</a></nav>
      </div>
    </main>
  </div>
  <script>

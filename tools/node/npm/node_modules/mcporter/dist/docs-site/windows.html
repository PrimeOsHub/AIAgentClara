...
<head>
  ...
  <title>Windows &amp; WSL tips — mcporter</title>
  <meta name="description" content="Windows &amp; WSL tips — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/windows.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Windows &amp; WSL tips — mcporter">
  <meta property="og:description" content="Windows &amp; WSL tips — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/windows.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Windows &amp; WSL tips — mcporter">
  <meta name="twitter:description" content="Windows &amp; WSL tips — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link active" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>Windows &amp; WSL tips</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/windows.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h2 id="installing-dependencies"><a class="anchor" href="#installing-dependencies" aria-label="Anchor link">#</a>Installing dependencies</h2>
<ul>
<li><code>pnpm install</code> fails on <code>/mnt/c</code> because NTFS/DrvFs blocks <code>futime</code>. Clone/sync the repo to <code>$HOME</code> (ext4 inside WSL) and run <code>./runner pnpm install</code> there instead. Example: <code>rsync -a --delete --exclude node_modules /mnt/c/Projects/mcporter/ ~/mcporter-wsl/</code>.</li>
<li>Keep <code>$HOME/.bun/bin</code> and <code>$HOME/.local/share/pnpm</code> on your PATH before invoking <code>./runner</code>. Without Bun and pnpm the runner prints the guardrail error and exits.</li>
<li>If you <em>must</em> work from <code>/mnt/c</code>, remount with <code>metadata</code> support (<code>sudo mount -t drvfs C: /mnt/c -o metadata,uid=$(id -u),gid=$(id -g),umask=22,fmask=111</code>). Otherwise installs, chmods, and copyfile calls will continue to fail.</li>
</ul>
<h2 id="running-tests"><a class="anchor" href="#running-tests" aria-label="Anchor link">#</a>Running tests</h2>
<ul>
<li>Use the ext4 copy (<code>~/mcporter-wsl</code>) for <code>pnpm lint</code>, <code>pnpm typecheck</code>, and the Vitest suites. All tests pass there (71 files / 280 tests, 1 file and 2 tests skipped).</li>
<li>Whole-repo <code>pnpm test</code> on <code>/mnt/c</code> repeatedly times out because Vitest cannot start workers when the node_modules tree belongs to root or sits on NTFS. Copy the repo to ext4 or fix ownership before retrying.</li>
<li>When working cross-filesystem, remember to sync the edited source files back to the canonical <code>/mnt/c/Projects/mcporter</code> tree (e.g., <code>rsync -a ~/mcporter-wsl/src/cli/generate/{template,artifacts,fs-helpers}.ts /mnt/c/Projects/mcporter/src/cli/generate/</code>).</li>
<li>The stdio integration suite now vendors two tiny fixtures under <code>tests/fixtures/stdio-*.mjs</code> that spin up filesystem/memory MCP servers via <code>node</code>. The tests shell out to <code>process.execPath</code>, so make sure your PATH resolves <code>node</code> correctly (fnm/nvs setups sometimes expose only <code>node.exe</code> on Windows). If you need to debug them manually, run <code>./runner pnpm exec vitest run tests/stdio-servers.integration.test.ts</code> so the guardrails apply.</li>
</ul>
<h2 id="windows-specific-fixes-in-the-repo"><a class="anchor" href="#windows-specific-fixes-in-the-repo" aria-label="Anchor link">#</a>Windows-specific fixes in the repo</h2>
<ul>
<li>CLI generation now uses <code>src/cli/generate/fs-helpers.ts</code>: <code>markExecutable</code> ignores <code>EPERM/EINVAL/ENOSYS/EACCES</code> so NTFS builds no longer fail when setting executable bits.</li>
<li><code>safeCopyFile</code> falls back to a manual read/write when DrvFs blocks <code>copyFile</code>, keeping Bun bundling stable on Windows.</li>
<li>These helpers only affect Windows/WSL behavior—Linux/macOS paths still perform real <code>chmod</code>/<code>copyFile</code>.</li>
<li>Regenerated CLIs (for example <code>node dist/cli.js generate-cli context7 --config config/mcporter.json --bundle /mnt/c/Temp/context7-cli.js --runtime node</code>) now complete successfully even when the bundle lives on <code>/mnt/c</code>, and the resulting executable runs with <code>node /mnt/c/Temp/context7-cli.js --help</code>.</li>
<li>When running <code>mcporter generate-cli</code> with <code>--command ./relative-script.ts</code>, the CLI no longer tries to normalize the path into an HTTP URL—relative/bare commands are always treated as STDIO transports now, matching the PowerShell/WSL behavior you expect.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="hang-debug.html"><small>Previous</small><span>Debugging Hanging mcporter Calls</span></a><a class="page-nav-next" href="tmux.html"><small>Next</small><span>tmux Hang Diagnostics</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#installing-dependencies">Installing dependencies</a><a class="toc-l2" href="#running-tests">Running tests</a><a class="toc-l2" href="#windows-specific-fixes-in-the-repo">Windows-specific fixes in the repo</a></nav>
      </div>
    </main>
  </div>
  <script>

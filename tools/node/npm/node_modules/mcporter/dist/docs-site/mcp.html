...
<head>
  ...
  <title>mcporter Overview — mcporter</title>
  <meta name="description" content="mcporter Overview — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/mcp.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="mcporter Overview — mcporter">
  <meta property="og:description" content="mcporter Overview — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/mcp.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="mcporter Overview — mcporter">
  <meta name="twitter:description" content="mcporter Overview — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link active" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Connecting servers</p>
          <h1>mcporter Overview</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/mcp.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="mcporter-overview">mcporter Overview</h1>
<p>mcporter is the Sweetistics CLI + runtime for the Model Context Protocol (MCP). It wraps the upstream TypeScript SDK with:</p>
<ul>
<li><strong>Runtime orchestration</strong> – <code>createRuntime</code> loads servers from config JSON, editor imports, or ad-hoc flags and handles OAuth retries, transport promotion, and cleanup.</li>
<li><strong>CLI surfaces</strong> – <code>mcporter list</code>, <code>mcporter call</code>, <code>mcporter generate-cli</code>, <code>mcporter emit-ts</code>, and <code>mcporter inspect-cli</code> expose the runtime features to humans and scripts.</li>
<li><strong>Tooling helpers</strong> – <code>createServerProxy</code> maps MCP tools to camelCase methods for Node/Bun scripts and returns <code>CallResult</code> helpers (<code>.text()</code>, <code>.markdown()</code>, <code>.json()</code>).</li>
</ul>
<h2 id="primary-commands"><a class="anchor" href="#primary-commands" aria-label="Anchor link">#</a>Primary Commands</h2>
<ul>
<li><code>npx mcporter list [server|--http-url|--stdio]</code>  </li>
<p>Lists tool metadata, renders TypeScript-style signatures, and surfaces copy/pasteable examples (including ad-hoc HTTP selectors).</p>
<li><code>npx mcporter call server.tool key=value …</code>  </li>
<p>Invokes a tool via either flag syntax or the function-call expression form; add <code>--output json</code> to capture structured responses.</p>
<li><code>npx mcporter resource server [uri]</code>  </li>
<p>Lists MCP resources for a server, or reads a specific resource URI and renders text/markdown/JSON/raw output.</p>
<li><code>npx mcporter generate-cli --server name [--bundle|--compile]</code>  </li>
<p>Emits a standalone CLI for a single MCP server. Bundling defaults to Rolldown unless the runtime resolves to Bun; compiled binaries require Bun.</p>
<li><code>npx mcporter emit-ts &lt;server&gt; --mode types|client</code>  </li>
<p>Produces <code>.d.ts</code> files or typed client factories that mirror the CLI schema output.</p>
<li><code>npx mcporter inspect-cli dist/server.js</code>  </li>
<p>Reads embedded metadata so you can regenerate a CLI without guesswork.</p>
</ul>
<h2 id="runtime-helpers"><a class="anchor" href="#runtime-helpers" aria-label="Anchor link">#</a>Runtime Helpers</h2>
<p>Use <code>createServerProxy(runtime, name)</code> inside scripts when you want ergonomic camelCase calls instead of kebab-case tool names. The proxy:</p>
<ol>
<li>Validates arguments against the MCP schema.</li>
<li>Automatically merges default values.</li>
<li>Returns a <code>CallResult</code> helper so you can render <code>.text()</code>, <code>.markdown()</code>, or <code>.json()</code> without manual parsing.</li>
</ol>
<p>When you need raw access (custom transports, streaming), use the bare <code>Client</code> from <code>@modelcontextprotocol/sdk</code> or inspect <code>runtime.connect(name)</code> for lower-level control.</p>
<h2 id="debug-support-docs"><a class="anchor" href="#debug-support-docs" aria-label="Anchor link">#</a>Debug + Support Docs</h2>
<ul>
<li><strong>Ad-hoc MCP Servers</strong> (<code>docs/adhoc.md</code>) – explains the <code>--http-url</code> / <code>--stdio</code> flags.</li>
<li><strong>Tool Calling Cheatsheet</strong> (<code>docs/tool-calling.md</code>) – shows the two argument styles and when to use each.</li>
<li><strong>Hang Diagnostics</strong> (<code>docs/hang-debug.md</code> + <code>docs/tmux.md</code>) – run long-lived commands inside tmux and dump active handles if shutdown stalls.</li>
</ul>
<p>Read these docs (via <code>pnpm run docs:list</code>) whenever your task touches the corresponding area. They contain the up-to-date guardrails used across Sweetistics repositories.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="daemon.html"><small>Previous</small><span>MCPorter Daemon Plan</span></a><a class="page-nav-next" href="agent-skills.html"><small>Next</small><span>Agent Skill Pattern</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#primary-commands">Primary Commands</a><a class="toc-l2" href="#runtime-helpers">Runtime Helpers</a><a class="toc-l2" href="#debug-support-docs">Debug + Support Docs</a></nav>
      </div>
    </main>
  </div>
  <script>

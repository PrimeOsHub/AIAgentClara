...
<head>
  ...
  <title>Call Syntax Reference — mcporter</title>
  <meta name="description" content="Call Syntax Reference — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/call-syntax.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Call Syntax Reference — mcporter">
  <meta property="og:description" content="Call Syntax Reference — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/call-syntax.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Call Syntax Reference — mcporter">
  <meta name="twitter:description" content="Call Syntax Reference — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link active" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">CLI</p>
          <h1>Call Syntax Reference</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/call-syntax.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="call-syntax-reference">Call Syntax Reference</h1>
<p><code>mcporter call</code> now understands two complementary styles:</p>
<table><thead><tr><th>Style</th><th>Example</th><th>Notes</th></tr></thead><tbody><tr><td>Flag-based (compatible)</td><td><code>mcporter call linear.create_comment --issue-id LNR-123 --body &quot;Hi&quot;</code></td><td>Use <code>--key value</code>, <code>--key=value</code>, <code>key=value</code>, <code>key:value</code>, or <code>key: value</code> pairs—ideal for shell scripts.</td></tr><tr><td>Function-call (expressive)</td><td><code>mcporter call &#39;linear.create_comment(issueId: &quot;LNR-123&quot;, body: &quot;Hi&quot;)&#39;</code></td><td>Mirrors the pseudo-TypeScript signature shown by <code>mcporter list</code>; unlabeled values map to schema order.</td></tr><tr><td>Structured output</td><td><code>mcporter call &#39;linear.create_comment(...)&#39; --output json</code></td><td>Successful calls emit JSON bodies; failures emit <code>{ server, tool, issue }</code> envelopes so automation can react to auth/offline/http errors.</td></tr></tbody></table>
<p>Both forms share the same validation pipeline, so required parameters, enums, and formats behave identically.</p>
<h2 id="reading-the-cli-signatures"><a class="anchor" href="#reading-the-cli-signatures" aria-label="Anchor link">#</a>Reading the CLI Signatures</h2>
<p><code>mcporter list &lt;server&gt;</code> prints each tool as a compact TypeScript declaration:</p>
...
// optional (3): notifySubscribers, labelIds, mentionIds, ...</code></pre>
<p>Key details:</p>
<ul>
<li>Doc blocks use <code>@param</code> lines so every parameter description (even optional ones) stays in view.</li>
<li>Required parameters appear without <code>?</code>; optional parameters use <code>?</code> and inherit enum literals (e.g. <code>&quot;json&quot; | &quot;markdown&quot;</code>).</li>
<li>Known format hints are appended inline: <code>dueDate?: string /* ISO 8601 */</code> (we suppress the hint when the description already calls it out).</li>
<li>When a tool exposes more than two optional parameters (or has ≥4 required parameters), the default output hides the extras and replaces them with an inline summary like <code>// optional (8): limit, before, after, orderBy, projectId, ...</code>.</li>
<li>Run <code>mcporter list &lt;server&gt; --all-parameters</code> whenever you want the full signature; the footer repeats <code>Optional parameters hidden; run with --all-parameters to view all fields.</code> any time truncation occurs.</li>
<li>Return types come from each tool’s output schema, so you’ll see concrete names when providers include <code>title</code> metadata (e.g. <code>DocumentConnection</code>). When no schema is advertised we omit the <code>: Type</code> suffix entirely instead of showing <code>unknown</code>.</li>
<li>Each server concludes with a short <code>Examples:</code> block that mirrors the preferred function-call syntax.</li>
<li>Run <code>mcporter list &lt;server&gt; --brief</code> (or <code>--signatures</code>) when you only want the compact signatures and optional summaries without doc blocks or examples.</li>
</ul>
<h2 id="function-call-syntax-details"><a class="anchor" href="#function-call-syntax-details" aria-label="Anchor link">#</a>Function-Call Syntax Details</h2>
<ul>
<li><strong>Named arguments preferred</strong>: <code>issueId: &quot;123&quot;</code> keeps calls self-documenting. When labels are omitted, mcporter falls back to positional order defined by the tool schema.</li>
<li><strong>Optional positional fallback</strong>: omit labels when calling <code>mcporter &#39;context7.resolve-library-id(&quot;React hooks docs&quot;, &quot;react&quot;)&#39;</code>—arguments map to the schema order after any explicitly named parameters.</li>
<li><strong>Literals supported</strong>: strings, numbers, booleans, <code>null</code>, arrays, and nested objects. For strings containing spaces or commas, wrap the entire call in single quotes to keep the shell happy.</li>
<li><strong>Error feedback</strong>: invalid keys, unsupported expressions, or parser failures bubble up with actionable messages (<code>Unsupported argument expression: Identifier</code>, <code>Unable to parse call expression: …</code>).</li>
<li><strong>Server selection</strong>: You can embed the server in the expression (<code>linear.create_comment(...)</code>) or pass it separately (<code>--server linear create_comment(...)</code>).</li>
</ul>
<h2 id="http-selectors-ad-hoc-urls"><a class="anchor" href="#http-selectors-ad-hoc-urls" aria-label="Anchor link">#</a>HTTP Selectors &amp; Ad-hoc URLs</h2>
<ul>
<li>You can skip <code>--server</code> entirely by pasting the MCP endpoint + tool name directly: <code>mcporter call &#39;https://www.shadcn.io/api/mcp.getComponent(component: &quot;vortex&quot;)&#39;</code>.</li>
<li>Mcporter strips the <code>.tool</code> suffix to derive the base server URL, reuses any configured definition that already points at that endpoint, and only registers a new ad-hoc server when necessary (<code>--allow-http</code> still guards plain HTTP URLs).</li>
<li>Function-call arguments continue to work in this form; if you omit parentheses you can still append <code>key=value</code> pairs (<code>https://.../mcp.getComponent component=vortex</code>).</li>
<li>This is especially handy for copy/pasting tool listings or experimenting with anonymous HTTP MCP servers—you get the same parsing, auto-correction, and logging pipeline as the regular <code>server.tool</code> syntax.</li>
<li>Protocols are optional; bare domains such as <code>shadcn.io/api/mcp.getComponents</code> automatically assume <code>https://</code>. If you really need plain HTTP, spell out <code>http://</code> and pass <code>--allow-http</code>.</li>
<li>Hostname comparisons ignore a leading <code>www.</code> so <code>https://shadcn.io/api/mcp</code> and <code>https://www.shadcn.io/api/mcp</code> resolve to the same configured server when possible.</li>
</ul>
<h2 id="tips"><a class="anchor" href="#tips" aria-label="Anchor link">#</a>Tips</h2>
<ul>
<li>Use <code>--args &#39;{ &quot;issueId&quot;: &quot;LNR-123&quot; }&#39;</code>, <code>--json &#39;{ &quot;issueId&quot;: &quot;LNR-123&quot; }&#39;</code>, or <code>--json -</code> if you already have JSON payloads.</li>
<li>The new syntax respects all existing features (timeouts, <code>--output</code>, auto-correction).</li>
<li>Required fields show by default; pass <code>--all-parameters</code> when you want the full parameter list (or <code>--schema</code> for raw JSON schemas).</li>
<li>When in doubt, run <code>mcporter list &lt;server&gt;</code> to see the current signature and sample invocation.</li>
</ul>
<h2 id="flag-based-syntax-details"><a class="anchor" href="#flag-based-syntax-details" aria-label="Anchor link">#</a>Flag-Based Syntax Details</h2>
<ul>
<li><code>--key value</code>, <code>--key=value</code>, <code>key=value</code>, <code>key:value</code>, <code>key: value</code>, and <code>key:=value</code> all map to the same named-argument handling, so you can type whichever feels most natural for your shell. Long flag keys convert kebab-case to camelCase (<code>--save-to-drafts true</code> becomes <code>saveToDrafts: true</code>). The <code>:=</code> form is accepted as a compatibility alias for <code>=</code>.</li>
<li>By default, arguments keep the same validation pipeline as the function-call syntax—enums, numbers, and booleans are coerced automatically, and missing required fields raise errors.</li>
<li><code>--args -</code> and <code>--json -</code> read a JSON object from stdin.</li>
<li>Bare string values supplied via long flags wrap into one-item arrays when the tool schema declares that field as an array.</li>
<li>Numeric-looking <code>key=value</code> arguments are restored to their original string spelling when the tool schema declares that parameter as a string, which keeps timestamp-like IDs such as Slack <code>thread_ts=1234567890.123456</code> intact.</li>
<li><code>--raw-strings</code> disables numeric coercion for flag-style and positional values so IDs/codes stay literal strings (<code>code=12345</code> stays <code>&quot;12345&quot;</code>).</li>
<li><code>--no-coerce</code> disables all coercion for flag-style and positional values (<code>true</code>, <code>null</code>, and JSON-like values remain strings).</li>
<li>Long flags without values fail fast. Insert <code>--</code> before literal positional values that start with <code>--</code>.</li>
<li><code>--save-images &lt;dir&gt;</code> keeps stdout formatting untouched while writing image content blocks to disk when a tool response includes <code>type: &quot;image&quot;</code> entries.</li>
<li><code>tool=value</code>/<code>tool:value</code> and <code>server=value</code> still act as aliases for <code>--tool</code> / <code>--server</code> when you need to override the selector.</li>
</ul><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="cli-reference.html"><small>Previous</small><span>mcporter CLI Reference</span></a><a class="page-nav-next" href="call-heuristic.html"><small>Next</small><span>Call Command Auto-Correction</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#reading-the-cli-signatures">Reading the CLI Signatures</a><a class="toc-l2" href="#function-call-syntax-details">Function-Call Syntax Details</a><a class="toc-l2" href="#http-selectors-ad-hoc-urls">HTTP Selectors &amp;amp; Ad-hoc URLs</a><a class="toc-l2" href="#tips">Tips</a><a class="toc-l2" href="#flag-based-syntax-details">Flag-Based Syntax Details</a></nav>
      </div>
    </main>
  </div>
  <script>

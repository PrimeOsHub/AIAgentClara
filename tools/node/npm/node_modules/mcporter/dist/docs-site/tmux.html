...
<head>
  ...
  <title>tmux Hang Diagnostics — mcporter</title>
  <meta name="description" content="tmux Hang Diagnostics — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/tmux.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="tmux Hang Diagnostics — mcporter">
  <meta property="og:description" content="tmux Hang Diagnostics — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/tmux.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="tmux Hang Diagnostics — mcporter">
  <meta name="twitter:description" content="tmux Hang Diagnostics — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link active" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>tmux Hang Diagnostics</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/tmux.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="tmux-hang-diagnostics">tmux Hang Diagnostics</h1>
<p>Use <code>tmux</code> to verify whether a CLI command actually exits or is stalled on open handles. This keeps the main shell free while you inspect logs.</p>
<ol>
<li>Start the command in a detached session:</li>
<p>``<code>bash tmux new-session -ds mcporter-check &quot;pnpm exec tsx src/cli.ts list&quot; </code>``</p>
<li>Wait a few seconds, then ask tmux if the session is still running:</li>
</ol>
<p>``<code>bash tmux has-session -t mcporter-check </code>``</p>
<ul>
<li>Exit status <strong>1</strong> (<code>can&#39;t find session</code>) means the process exited normally.</li>
<li>Exit status <strong>0</strong> means the command is still running (or hung) inside the session.</li>
</ul>
<ol>
<li>Capture the output without attaching:</li>
<p>``<code>bash tmux capture-pane -pt mcporter-check | tail -n 40 </code>``</p>
<li>Once finished, clean up the session:</li>
<p>``<code>bash tmux kill-session -t mcporter-check </code>``</p>
</ol>
<p>This workflow makes it easy to confirm whether <code>mcporter</code> commands return promptly after shutdown changes (for example, when debugging lingering MCP stdio servers). Use <code>MCPORTER_DEBUG_HANG=1</code> to emit active-handle diagnostics inside the tmux session when necessary. For OAuth flows that keep a session open, set <code>--oauth-timeout 5000</code> (or <code>MCPORTER_OAUTH_TIMEOUT_MS=5000</code>) so the CLI proves it can exit without waiting the full 5 minute default for a browser callback.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="windows.html"><small>Previous</small><span>Windows &amp; WSL tips</span></a><a class="page-nav-next" href="known-issues.html"><small>Next</small><span>Known Issues</span></a></nav></article>

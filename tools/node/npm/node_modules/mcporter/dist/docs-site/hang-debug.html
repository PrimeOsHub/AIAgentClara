...
<head>
  ...
  <title>Debugging Hanging mcporter Calls — mcporter</title>
  <meta name="description" content="Debugging Hanging mcporter Calls — mcporter documentation.">
  <link rel="canonical" href="https://mcporter.sh/hang-debug.html">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="mcporter">
  <meta property="og:title" content="Debugging Hanging mcporter Calls — mcporter">
  <meta property="og:description" content="Debugging Hanging mcporter Calls — mcporter documentation.">
  <meta property="og:url" content="https://mcporter.sh/hang-debug.html">
  <meta property="og:image" content="https://mcporter.sh/social-card.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Debugging Hanging mcporter Calls — mcporter">
  <meta name="twitter:description" content="Debugging Hanging mcporter Calls — mcporter documentation.">
...
<body>
  ...
  <div class="shell">
    ...
    <svg class="theme-icon-sun" viewBox="0 0 20 20" aria-hidden="true"><circle cx="10" cy="10" r="3.4" fill="currentColor"/><g stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><line x1="10" y1="2" x2="10" y2="4"/><line x1="10" y1="16" x2="10" y2="18"/><line x1="2" y1="10" x2="4" y2="10"/><line x1="16" y1="10" x2="18" y2="10"/><line x1="4.2" y1="4.2" x2="5.6" y2="5.6"/><line x1="14.4" y1="14.4" x2="15.8" y2="15.8"/><line x1="4.2" y1="15.8" x2="5.6" y2="14.4"/><line x1="14.4" y1="5.6" x2="15.8" y2="4.2"/></g></svg>
      ...
      <nav><section><h2>Start</h2><a class="nav-link" href="./">Overview</a><a class="nav-link" href="install.html">Install</a><a class="nav-link" href="quickstart.html">Quickstart</a><a class="nav-link" href="config.html">CLI Help Menu Snapshot</a></section><section><h2>CLI</h2><a class="nav-link" href="cli-reference.html">mcporter CLI Reference</a><a class="nav-link" href="call-syntax.html">Call Syntax Reference</a><a class="nav-link" href="call-heuristic.html">Call Command Auto-Correction</a><a class="nav-link" href="shortcuts.html">Agent Shortcuts</a><a class="nav-link" href="logging.html">Logging &amp; Diagnostics</a></section><section><h2>Generators</h2><a class="nav-link" href="cli-generator.html">CLI Generator Plan</a><a class="nav-link" href="emit-ts.html">emit-ts</a><a class="nav-link" href="tool-calling.html">Tool Calling Cheatsheet</a></section><section><h2>Connecting servers</h2><a class="nav-link" href="adhoc.html">Ad-hoc MCP Servers</a><a class="nav-link" href="import.html">Import Reference</a><a class="nav-link" href="local.html">Running mcporter Locally</a><a class="nav-link" href="daemon.html">MCPorter Daemon Plan</a><a class="nav-link" href="mcp.html">mcporter Overview</a></section><section><h2>Agents</h2><a class="nav-link" href="agent-skills.html">Agent Skill Pattern</a><a class="nav-link" href="subagent.html">Claude Subagent Quickstart</a></section><section><h2>Operations</h2><a class="nav-link" href="RELEASE.html">Release Checklist</a><a class="nav-link" href="manual-testing.html">Manual Testing Harness</a><a class="nav-link" href="livetests.html">Live MCP Tests</a><a class="nav-link active" href="hang-debug.html">Debugging Hanging mcporter Calls</a><a class="nav-link" href="windows.html">Windows &amp; WSL tips</a><a class="nav-link" href="tmux.html">tmux Hang Diagnostics</a><a class="nav-link" href="known-issues.html">Known Issues</a><a class="nav-link" href="supabase-auth-issue.html">OAuth Notes &amp; Hosted MCP Compatibility</a></section><section><h2>Reference</h2><a class="nav-link" href="spec.html">mcporter Roadmap</a><a class="nav-link" href="migration.html">Migration Guide</a><a class="nav-link" href="pnpm-mcp-migration.html">Migrating from `pnpm mcp:*</a><a class="nav-link" href="refactor.html">Next-Step Refactor Checklist</a></section></nav>
    </aside>
    <main>
      <header class="hero">
        <div class="hero-text">
          <p class="eyebrow">Operations</p>
          <h1>Debugging Hanging mcporter Calls</h1>
        </div>
        <div class="hero-meta">
          <a class="repo" href="https://github.com/openclaw/mcporter" rel="noopener">GitHub</a>
          <a class="edit" href="https://github.com/openclaw/mcporter/edit/main/docs/hang-debug.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
        <article class="doc"><h1 id="debugging-hanging-mcporter-calls">Debugging Hanging mcporter Calls</h1>
<p>When <code>mcporter call</code> prints a tool response but the process never exits, it usually means Node still has active handles it is waiting on. The most common culprit is a child MCP server process that keeps the stdio transport alive.</p>
<h2 id="quick-checklist"><a class="anchor" href="#quick-checklist" aria-label="Anchor link">#</a>Quick Checklist</h2>
<ol>
<li><strong>Run under tmux</strong> – launch the command inside tmux so you can inspect the</li>
<p>pane even after Cursor or another agent times out.</p>
<li><strong>Enable hang diagnostics</strong> – set <code>MCPORTER_DEBUG_HANG=1</code> when invoking the</li>
<p>CLI. mcporter will dump the active handles/requests after the tool finishes and around the <code>runtime.close()</code> call.</p>
<li><strong>Inspect the handle list</strong> – look for <code>ChildProcess (pid=…)</code> entries. If a</li>
<p>child remains, mcporter will now unref and force-kill it, but the debug list tells you exactly what was keeping the event loop alive.</p>
<li><strong>Capture the pane output</strong> – run `tmux capture-pane -p -t &lt;session&gt; -S</li>
<p>-200` to save the diagnostic log for later review.</p>
<li><strong>Retry with <code>--timeout</code></strong> – if the tool itself hangs, use</li>
<p><code>--timeout &lt;ms&gt;</code> or <code>MCPORTER_CALL_TIMEOUT</code> to fail fast while still gathering diagnostics.</p>
<li><strong>Clamp OAuth waits</strong> – when the browser-based sign-in never completes,</li>
<p>run with <code>--oauth-timeout &lt;ms&gt;</code> (or <code>MCPORTER_OAUTH_TIMEOUT_MS</code>) so the CLI tears down the pending flow instead of waiting the full 5 minutes.</p>
</ol>
<h2 id="example-session"><a class="anchor" href="#example-session" aria-label="Anchor link">#</a>Example Session</h2>
<pre><code class="language-bash">tmux new-session -d -s mcphang \
  &#39;cd /path/to/project &amp;&amp; \
...
sleep 5
tmux capture-pane -p -t mcphang -S -200</code></pre>
<p>Sample diagnostic output (abridged):</p>
<pre><code class="language-text">[mcporter] [debug] after call (object result): 6 active handle(s), 0 request(s)
...
[mcporter] [debug] forcibly killed child pid=78480 (runtime.finally)</code></pre>
<p>This confirms the CLI response completed and that the lingering handle was a child process, which mcporter will now terminate during shutdown.</p>
<h2 id="notes"><a class="anchor" href="#notes" aria-label="Anchor link">#</a>Notes</h2>
<ul>
<li>The diagnostics only appear when <code>MCPORTER_DEBUG_HANG=1</code> is set.</li>
<li>Killing residual children is best-effort; if you see repeated <code>kill-failed</code></li>
<p>messages, manually terminate the PID listed in the log.</p>
<li>Always keep tmux sessions tidy after debugging: `tmux kill-session -t</li>
<p>&lt;session&gt;`.</p>
<li>The CLI now forces <code>process.exit(0)</code> after cleanup by default so Node never</li>
<p>lingers on leaked handles. Export <code>MCPORTER_NO_FORCE_EXIT=1</code> if you’re debugging and need the process to stay alive.</p>
<li>You can still set <code>MCPORTER_FORCE_EXIT=1</code> explicitly when you want to force</li>
<p>termination even with <code>MCPORTER_NO_FORCE_EXIT</code> in play.</p>
<li>Stdio servers have their stderr output suppressed by default; set</li>
<p><code>MCPORTER_STDIO_LOGS=1</code> to print their logs (they’re also surfaced whenever a child exits with a non-zero status).</p>
</ul>
<h2 id="upstream-tracking"><a class="anchor" href="#upstream-tracking" aria-label="Anchor link">#</a>Upstream Tracking</h2>
<ul>
<li><code>@modelcontextprotocol/sdk</code> <strong>1.21.0</strong> is the latest release pulled into mcporter.</li>
<li>Open SDK issues related to stdio shutdown:</li>
<li><a href="https://github.com/modelcontextprotocol/typescript-sdk/issues/579">#579 StdioClientTransport does not follow the spec on close</a></li>
<li><a href="https://github.com/modelcontextprotocol/typescript-sdk/issues/780">#780 onerror listeners not removed after client close (stdio)</a></li>
<li><a href="https://github.com/modelcontextprotocol/typescript-sdk/issues/1049">#1049 stdio client crashes when spawned server exits unexpectedly</a></li>
</ul>
<p>We keep a local checkout of the SDK under <code>~/Projects/typescript-sdk/</code> so we can diff against upstream and craft repros/patches quickly. Any mcporter-specific workarounds live in <code>src/sdk-patches.ts</code> until the upstream fixes land.</p><nav class="page-nav" aria-label="Pager"><a class="page-nav-prev" href="livetests.html"><small>Previous</small><span>Live MCP Tests</span></a><a class="page-nav-next" href="windows.html"><small>Next</small><span>Windows &amp; WSL tips</span></a></nav></article>
        <nav class="toc" aria-label="On this page"><h2>On this page</h2><a class="toc-l2" href="#quick-checklist">Quick Checklist</a><a class="toc-l2" href="#example-session">Example Session</a><a class="toc-l2" href="#notes">Notes</a><a class="toc-l2" href="#upstream-tracking">Upstream Tracking</a></nav>
      </div>
    </main>
  </div>
  <script>

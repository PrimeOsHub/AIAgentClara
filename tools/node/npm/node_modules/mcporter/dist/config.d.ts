...
export type { CommandSpec, HttpCommand, LoadConfigOptions, RawConfig, RawEntry, RawLifecycle, RefreshableBearerOptions, ServerDefinition, ServerLifecycle, ServerLoggingOptions, ServerSource, StdioCommand, } from './config-schema.js';
export declare function loadServerDefinitions(options?: LoadConfigOptions): Promise<ServerDefinition[]>;
export interface DaemonConfig {
    readonly idleTimeoutMs?: number;
}
export declare function loadDaemonConfig(options?: LoadConfigOptions): Promise<DaemonConfig>;

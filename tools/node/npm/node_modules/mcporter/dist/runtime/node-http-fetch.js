...
export const nodeHttp1Fetch = async (input, init = {}) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const request = client.request(url, {
            ...
            if (REDIRECT_STATUSES.has(status) && location && init.redirect !== 'manual') {
                ...
                resolve(nodeHttp1FetchWithRedirects(nextUrl, buildRedirectInit(init, status, url, nextUrl), redirectCount + 1));
                return;
            }
...
//# sourceMappingURL=node-http-fetch.js.map
...
export function markOAuthFlowError(error) {
...
export function markPostAuthConnectError(error) {
    return markError(error, POST_AUTH_CONNECT_ERROR);
}
export function isPostAuthConnectError(error) {
    ...
    while (true) {
        try {
            ...
            try {
                ...
                const message = authError instanceof OAuthAuthorizationNotStartedError
...
export function parseOAuthTimeout(raw) {
    if (!raw) {
...
export function resolveOAuthTimeoutFromEnv() {

...
export async function cmdTransferRequest(opts, slugArg, toHandleArg, options, inputAllowed) {
    ...
    const confirmed = await requireYesOrConfirm(options, inputAllowed, `Transfer ${slug} to @${toHandle}? User transfers require recipient acceptance; org transfers apply immediately if you are an admin of both owners.`);
    if (!confirmed)
        return undefined;

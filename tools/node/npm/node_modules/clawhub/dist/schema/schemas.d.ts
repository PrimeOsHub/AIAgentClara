...
export declare const ApiV1PublisherEnsureResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    publisherId: string;
    handle: string;
    created: boolean;
...
export declare const ApiV1BanUserResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    alreadyBanned: boolean;
    deletedSkills: number;
}, {}>;
export declare const ApiV1UnbanUserResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    alreadyUnbanned: boolean;
    restoredSkills?: number | undefined;
}, {}>;
